...
// ---------- UNIDAD 1 · SECCIÓN 1.3 ----------
{
  ...
  resumen: {
    intro: "Resumen condensado de toda la materia para repasar antes del final: arranca en los conceptos fundamentales de ingeniería de software y llega hasta el TP integrador, pasando por ciclos de vida, métodos ágiles, modelado de negocio, ingeniería de requerimientos, especificación (SRS), casos de uso e historias de usuario, V&amp;V y pruebas, diagramas de secuencia y tipos de sistemas. Cada tema enlaza a su sección completa con el botón “Leer completo”.",
    units: [
    {
      unit: '1',
      sections: [
        { id: '1.1', title: '¿Qué es la ingeniería de software?', blocks: [
          { type: 'h3', text: 'El origen: la crisis del software (1968)' },
          { type: 'p', text: 'En 1968 la <strong>OTAN</strong> realizó la primera conferencia sobre desarrollo de software, donde se acuñaron los términos <strong>crisis del software</strong> (los problemas en el desarrollo de sistemas) e <strong>ingeniería del software</strong> (el conjunto de conocimientos de aquel estado inicial).' },
          { type: 'p', text: 'La <strong>crisis del software</strong> fue el resultado de proyectos que se extendían más allá de costos y tiempos planificados (a veces cancelados), y los que se completaban tenían <strong>alto costo de mantenimiento</strong>, a veces equiparable al del desarrollo. Esto motivó una disciplina que aportara <strong>métodos, técnicas y herramientas</strong> a los procesos.' },
          { type: 'h3', text: 'Las definiciones clásicas' },
          { type: 'ul', items: [
            '<strong>Fritz Bauer</strong> (original): "Establecimiento y uso de principios de ingeniería para obtener software económico que trabaje de forma eficiente en máquinas reales".',
            '<strong>IEEE</strong> (1993): "La aplicación de métodos sistemáticos, disciplinados y cuantificables para el desarrollo, operación y mantenimiento de software".',
            '<strong>Barry W. Boehm</strong> (la más completa según el apunte): "la aplicación práctica del conocimiento científico al diseño y construcción de programas y la documentación asociada requerida para desarrollar, operar y mantenerlos".',
          ] },
          { type: 'h3', text: 'Producto y proceso de software' },
          { type: 'p', text: 'El <strong>producto de software</strong> no es solo el ejecutable: incluye el código objeto, el manual de usuario y los <strong>documentos asociados</strong> (requerimientos, diseño, código fuente, datos de prueba, etc.).' },
          { type: 'p', text: 'El <strong>proceso</strong> es lo que genera el producto a partir de los requerimientos. <strong>Sommerville</strong> lo define como "un conjunto de actividades cuya meta es el desarrollo o evolución del software".' },
          { type: 'h3', text: 'El rol del ingeniero de software' },
          { type: 'ul', items: [
            'Poseer <strong>experiencia en programación</strong>.',
            'Conocer de <strong>estructuras de datos</strong>.',
            '<strong>Traducir requerimientos y deseos vagos</strong> en una especificación clara.',
            'Manejar <strong>diferente vocabulario</strong> (técnico con el equipo, de aplicación con el usuario).',
            'Moverse en <strong>diferentes niveles de abstracción</strong>.',
            'Conocer <strong>modelado de procesos y de datos</strong>.',
            '<strong>Comunicación interpersonal y administración del trabajo</strong> (es una disciplina en interacción con otros, no individual).',
          ] },
          { type: 'callout', tone: 'criollo', text: 'El producto NO es solo el ejecutable, el proceso lleva de los requerimientos al producto, y el ingeniero es mucho más que un programador.' },
        ] },
        { id: '1.2', title: 'Sistemas vs. software', blocks: [
          { type: 'h3', text: '¿Qué es un sistema?' },
          { type: 'p', text: 'Un sistema es una "<strong>colección de componentes organizados para cumplir una función o conjunto de funciones específicas</strong>" (IEEE Standard 610.12-1990). Un <strong>sistema basado en computadoras</strong> no es solo software; sus componentes son:' },
          { type: 'ul', items: [
            '<strong>Software</strong>: los programas de computadora.',
            '<strong>Hardware</strong>: los dispositivos electrónicos.',
            '<strong>Gente</strong>: usuarios y operadores.',
            '<strong>Base de datos</strong>: la información que maneja el software.',
            '<strong>Documentación</strong>: los manuales para operar.',
            '<strong>Procedimientos</strong>: indican el uso de cada elemento.',
          ] },
          { type: 'h3', text: '¿Qué es el software?' },
          { type: 'p', text: 'El software es un componente <strong>lógico</strong> del sistema (a diferencia del hardware, físico): un sistema o sub-sistema formado por una <strong>colección de programas y documentación</strong> que en conjunto satisfacen ciertos requisitos.' },
          { type: 'h3', text: 'Sistema independiente vs. sub-sistema de software' },
          { type: 'p', text: 'Un sistema de software puede ser un <strong>sistema independiente</strong> (corre en un ordenador por sí solo) o formar parte de un <strong>sistema mayor</strong>, en cuyo caso es un <strong>sub-sistema de software</strong>. Ejemplo: el GPS del celular es un sub-sistema del software del celular.' },
          { type: 'callout', tone: 'criollo', text: 'Sistema es el todo (gente, fierros, datos, etc.); el software es la parte lógica, que puede ser autónoma o un sub-sistema de algo más grande.' },
        ] },
        { id: '1.3', title: 'Calidad, cualidades, principios y esencia/accidente', blocks: [
          { type: 'h3', text: 'Calidad del software y sus vistas' },
          { type: 'p', text: 'Calidad no significa "excelencia" a secas. Según la <strong>IEEE</strong>: el software tiene calidad cuando posee una <strong>buena combinación de atributos deseados</strong> y el cliente percibe que <strong>cumple con sus expectativas</strong>. Cada involucrado tiene una <strong>vista diferente</strong>: el usuario (confiable, eficiente, fácil de usar), el desarrollador (fácil de verificar o mantener), el administrador (productividad y eficiencia del proceso).' },
          { type: 'h3', text: 'Calidad del proceso vs. del producto' },
          { type: 'p', text: 'La <strong>calidad del proceso afecta directamente la del producto</strong>. En el hardware el vínculo es claro; pero el software <strong>no se fabrica</strong>: es un proceso más creativo que mecánico, donde pesan la experiencia y habilidades individuales. Aun así, un buen proceso minimiza los defectos del producto.' },
          { type: 'h3', text: 'Cualidades del software' },
          { type: 'p', text: 'Las cualidades son características del producto o de su proceso. Según <strong>Ghezzi</strong> se clasifican en <strong>internas</strong> (relevantes para los desarrolladores) y <strong>externas</strong> (relevantes para los usuarios). El software se distingue por su <strong>maleabilidad</strong>: se modifica con facilidad.' },
          { type: 'table', caption: 'Cualidades del producto y del proceso', headers: ['Cualidad', 'Significado'], rows: [
            ['Correctitud', 'Se comporta de acuerdo a la especificación de funciones que debería proveer.'],
            ['Confiabilidad', 'El usuario puede depender de él; probabilidad de operar como se espera en un intervalo de tiempo dado.'],
            ['Robustez', 'Se comporta razonablemente aun en circunstancias no anticipadas en la especificación.'],
            ['Performance', 'Eficiencia: usa los recursos en forma económica (tiempo, memoria).'],
            ['Amigabilidad', 'Fácil de usar; es más que la interfaz (correctitud y performance también la afectan).'],
            ['Verificabilidad', 'Sus propiedades se comprueban fácilmente; la favorece el diseño modular.'],
            ['Mantenibilidad', 'Modificaciones tras la entrega: arreglar errores e incorporar mejoras.'],
            ['Reusabilidad', 'Aplica más a una parte que al producto entero; hay que pensarla al desarrollar los componentes.'],
            ['Portabilidad', 'Puede correr en distintos ambientes (hardware, software o sistema operativo).'],
            ['Interoperabilidad', 'Coexiste y coopera con otros sistemas (ej.: importar/exportar datos).'],
            ['Productividad', 'Eficiencia del proceso de producción según los recursos requeridos.'],
            ['Oportunidad', 'Cualidad del proceso: entregar un producto a tiempo.'],
            ['Visibilidad', 'Sus pasos y estado actual están documentados y accesibles para examinación externa.'],
            ['Integridad', 'Controla los accesos no autorizados a datos o software.'],
          ] },
          { type: 'callout', tone: 'warning', text: 'No todas las cualidades se le piden a cada producto: hay que identificar cuáles son relevantes al establecer los requisitos (ej.: no todo producto necesita ser portable).' },
          { type: 'h3', text: 'Principios de la ingeniería de software' },
          { type: 'p', text: 'A diferencia de las cualidades, los principios se aplican <strong>a través de todo el proceso de desarrollo y la evolución del software</strong>; son la piedra angular de la disciplina.' },
          { type: 'ul', items: [
            '<strong>Rigor y formalidad</strong>: el rigor complementa a la creatividad; su nivel más alto es la formalidad (conducir y evaluar el proceso mediante leyes matemáticas).',
            '<strong>Separación de incumbencias</strong>: tratar aspectos individuales del problema por separado.',
            '<strong>Modularidad</strong>: dividir el sistema en módulos. Buen diseño = <strong>alta cohesión</strong> (interrelación interna del módulo) y <strong>bajo acoplamiento</strong> (relación entre módulos).',
            '<strong>Abstracción</strong>: identificar los aspectos importantes e ignorar los no relevantes.',
            '<strong>Anticipación al cambio</strong>: identificar necesidades de reparación o evolución; de esto se ocupa la Administración de configuraciones (control de versiones y revisiones).',
            '<strong>Generalización</strong>: descubrir un problema más general oculto detrás del que se trata.',
            '<strong>Incrementalidad</strong>: identificar subconjuntos de la aplicación para entregas tempranas y realimentación.',
          ] },
          { type: 'h3', text: 'Esencia y accidente (Brooks, "No silver bullet")' },
          { type: 'p', text: 'Según <strong>Frederick Brooks</strong> en "<strong>No silver bullet</strong>", las dificultades se clasifican en esenciales y accidentales. Las <strong>esenciales</strong> son inherentes a la naturaleza del software (<strong>complejidad, conformidad, variabilidad o mutabilidad e invisibilidad</strong>) y persisten pese al progreso tecnológico. Las <strong>accidentales</strong> asisten a la producción pero no son inherentes, por lo que varían con los avances (ej.: lenguajes de programación, limitaciones de espacio o velocidad de los dispositivos).' },
          { type: 'callout', tone: 'criollo', text: 'Cualidades = atributos del producto/proceso; principios = se aplican durante todo el proceso. De Brooks: las esenciales no se las saca nadie, las accidentales sí mejoran con la tecnología.' },
        ] },
      ],
    },
    {
      ...
      sections: [
        {
          ...
          title: 'El ciclo de vida y los modelos tradicionales',
          blocks: [
            { type: 'p', text: 'El desarrollo de software involucra un conjunto de actividades para su producción. Este proceso se llama <strong>ciclo de vida</strong> porque abarca desde que surge la necesidad inicial de un sistema hasta que el mismo sale de uso.' },
            { type: 'p', text: 'Los modelos de ciclo de vida (también llamados <strong>paradigmas de proceso</strong>) definen el orden en que un proyecto se especifica, prototipea, diseña, prueba e implementa. Elegir el correcto ayuda a la productividad, la calidad, la disminución de riesgos y el acercamiento al cliente.' },
            { type: 'p', text: 'Se abordan cinco modelos: clásico (cascada), espiral, incremental, prototipos y evolutivo UP.' },
            { type: 'h3', text: 'Ciclo de vida clásico (cascada)' },
            { type: 'p', text: 'Es el <strong>primer modelo</strong> y la base de muchos posteriores. Llamado <strong>cascada o lineal</strong> porque las actividades son <strong>secuenciales</strong>: cada etapa debe finalizar por completo para habilitar la siguiente, lo que lo vuelve un modelo <strong>muy rígido</strong>.' },
            { type: 'p', text: 'Sus etapas son: análisis y especificación de requerimientos, diseño, codificación, pruebas, integración, operación y mantenimiento.' },
            { type: 'ul', items: [
              '<strong>Análisis y especificación de requerimientos</strong>: relevar y analizar requerimientos para concluir en una especificación formal. Determina el "qué".',
              '<strong>Diseño</strong>: se ocupa del "cómo". Divide el sistema en módulos; define algoritmos, estructuras de datos, arquitectura, procedimientos e interfaces.',
              '<strong>Codificación</strong>: traducir el diseño al lenguaje de programación definido.',
              '<strong>Pruebas</strong>: constatar que el código responda a los requerimientos (entradas generan salidas esperadas).',
              '<strong>Integración</strong>: combinar los módulos para conformar el sistema.',
              '<strong>Operación y mantenimiento</strong>: operación es la puesta en uso por el cliente; mantenimiento es toda modificación posterior a la entrega (corregir errores, adaptarse al entorno o agregar funcionalidades).',
            ] },
            { type: 'p', text: 'Como las etapas se suceden escalonadamente, <strong>no hay solapamiento</strong> y todo el grupo está en la misma etapa a la vez; por eso no requiere personal muy experto en administración. Debe aplicarse cuando los <strong>requisitos estén completamente definidos al inicio</strong> y no se esperen cambios. Su gran desventaja: no le deja ver al cliente los avances hasta etapas muy avanzadas, y exige completar toda la documentación de cada etapa.' },
            { type: 'h3', text: 'Modelo espiral' },
            { type: 'p', text: 'Surge en los <strong>años 80</strong>, propuesto por <strong>Barry Boehm</strong>. Su aporte clave: incorpora el <strong>análisis de riesgos</strong> al ciclo de vida. Plantea el proyecto como una <strong>sumatoria de mini proyectos</strong>, cada uno centrado en uno o más riesgos.' },
            { type: 'p', text: 'Tiene <strong>cuatro cuadrantes</strong> (actividades):' },
            { type: 'ul', items: [
              '<strong>Planificación</strong>: definir objetivos y alternativas según las restricciones del proceso y del producto.',
              '<strong>Análisis de riesgos</strong>: analizar alternativas, elegir la más ventajosa e identificar y prevenir riesgos.',
              '<strong>Ingeniería</strong>: desarrollo del producto según la planificación y el análisis de riesgos (aplica un modelo como cascada).',
              '<strong>Evaluación del cliente</strong>: el cliente valora lo realizado para decidir cómo seguir.',
            ] },
            { type: 'p', text: 'Se grafica como una espiral sobre ejes cartesianos que crece con cada giro; en cada ciclo se realiza una parte del desarrollo atravesando las cuatro actividades.' },
            { type: 'h3', text: 'Modelo incremental' },
            { type: 'p', text: 'Le <strong>suma flexibilidad a la cascada</strong>, subsanando que el cliente no veía el avance. Parte de una especificación de requerimientos y <strong>descompone el desarrollo en partes</strong>, aplicando un ciclo a cada una y generando <strong>subsistemas operativos</strong> que el cliente dispone de forma incremental.' },
            { type: 'p', text: 'Las entregas parciales más cortas permiten <strong>completar o corregir los requisitos durante el desarrollo</strong>. Requiere algo más de experiencia, ya que cada entrega debe ser una <strong>versión operativa</strong> usable. Una variante, el <strong>Diseño por planificación</strong>, fija las entregas por prioridad del cliente en orden decreciente, de modo que si el proyecto se cancela ya estén los requisitos más prioritarios.' },
            { type: 'h3', text: 'Modelo de prototipos' },
            { type: 'p', text: 'Un <strong>prototipo</strong> es un modelo que simula el funcionamiento que debería tener el sistema. Es útil cuando el cliente no puede describir claramente qué desea, o cuando el desarrollador desconoce las actividades de la organización.' },
            { type: 'p', text: 'Originalmente se hacía un <strong>prototipo descartable</strong> (centrado en la interfaz) que se desechaba tras definir entradas, salidas y procesos. Como eso generaba conflictos, se pasó a desarrollar el prototipo sobre la arquitectura elegida, volviéndolo <strong>evolutivo</strong> (no se descarta lo realizado).' },
            { type: 'p', text: 'Se categorizan en <strong>Ligeros</strong> (bocetos de pantallas que simulan navegación) y <strong>Operativos</strong> (módulos que cubren partes de la funcionalidad).' },
            { type: 'callout', tone: 'criollo', text: 'El objetivo del prototipo es laburar con el cliente para sacarle retroalimentación y definir bien los requisitos.' },
          ],
        },
        {
          id: '2.2',
          title: 'Modelo evolutivo y Proceso Unificado (UP)',
          blocks: [
            { type: 'h3', text: 'Modelo evolutivo' },
            { type: 'p', text: 'Está conformado por <strong>varios ciclos de desarrollo</strong> que enlazan las actividades de <strong>especificación, desarrollo y validación</strong>, y cada uno genera un <strong>sistema completo</strong> que el cliente puede operar.' },
            { type: 'p', text: 'Parte del <strong>desarrollo rápido de un sistema inicial</strong> a partir de una lista de especificaciones, que se <strong>refina con las nuevas peticiones del cliente</strong>. A medida que el cliente opera la versión entregada, surge la información para ampliar los requisitos y diseñar la próxima versión.' },
            { type: 'p', text: 'Es útil cuando hay <strong>desconocimiento sobre las necesidades</strong> del sistema. Esto pasa cuando:' },
            { type: 'ul', items: [
              'No se posee experiencia previa en el área.',
              'Se trata de un nuevo entorno para el sistema.',
              'Se requiere el sistema con extremada urgencia y no hay tiempo para identificar todos los requerimientos.',
              'El sistema operará en un entorno cambiante (ej. normas jurídicas aún en definición).',
            ] },
            { type: 'h3', text: 'Modelo UP (Proceso Unificado)' },
            { type: 'p', text: 'El <strong>Proceso Unificado de Rational (RUP)</strong> está asociado al <strong>Lenguaje Unificado de Modelado (UML)</strong> y surge del Proceso Unificado de Desarrollo de Software, propuesto por <strong>Ivar Jacobson, Grady Booch y James Rumbaugh</strong>. Es un claro ejemplo de <strong>modelo híbrido</strong>.' },
            { type: 'p', text: 'Define <strong>cuatro fases</strong> (representadas en columnas); cada una concluye con un <strong>entregable</strong> (modelo o documentación).' },
            { type: 'table', headers: ['Fase', 'En qué consiste'], rows: [
              ['Inicio', 'Se establecen los procesos de negocio, se identifica con quién interactúa el sistema y las interacciones.'],
              ['Elaboración', 'Comprender el dominio, generar el marco arquitectónico, el plan y los riesgos. Finaliza con el modelo de requerimientos (casos de uso), la arquitectura y el plan de desarrollo.'],
              ['Construcción', 'Diseño, programación y pruebas. Finaliza con un sistema operativo y su documentación.'],
              ['Transición', 'El sistema pasa del desarrollo al entorno real. Finaliza cuando opera correctamente en producción con su documentación.'],
            ] },
            { type: 'p', text: 'Según su complejidad, cada fase puede dividirse en <strong>iteraciones</strong> (cada una un <strong>incremento</strong>). A su vez, cada iteración pasa por <strong>flujos de trabajo</strong> (filas en la gráfica) que se corresponden con las etapas de la cascada: <strong>requisitos, análisis, diseño, implementación y pruebas</strong>.' },
            { type: 'callout', tone: 'criollo', text: 'La posta del UP: es iterativo e incremental, armado con fases, ciclos y flujos de trabajo.' },
          ],
        },
      ],
    },
    {
      unit: '3',
      sections: [
        { id: '3.1', title: 'Metodologías ágiles: XP y Scrum', blocks: [
          { type: 'p', text: 'Los modelos tradicionales (<strong>cascada</strong>, <strong>evolutivo</strong>) servían para planificar y asegurar calidad en <strong>sistemas grandes</strong>, con equipos numerosos y mucho tiempo de vigencia. Pero al aplicarlos a <strong>pequeños proyectos</strong> definir todo de antemano llevaba más tiempo que programar, y eran <strong>rígidos</strong> ante cambios.' },
          { type: 'p', text: 'En la década del 90 surgieron los <strong>métodos ágiles</strong>: enfoques iterativos centrados en generar <strong>software funcional de manera rápida</strong>, con el diseño y la documentación acompañando el proceso. <strong>Kent Beck</strong> fue precursor con <em>Extreme Programming Explained</em> (XP). En <strong>2001</strong>, de la reunión de críticos de los modelos tradicionales surgió el <strong>Manifiesto Ágil</strong> (Kent Beck, Ken Schwaber, Martin Fowler, Robert C. Martin, Jeff Sutherland, entre otros).' },
          { type: 'p', text: '<strong>Principios de los métodos ágiles:</strong>' },
          { type: 'ul', items: [
            '<strong>Participación del cliente</strong> en el desarrollo.',
            'Desarrollo de software en forma <strong>incremental</strong>.',
            'Priorizar <strong>personas y no procesos</strong>.',
            'Aceptar que los <strong>requerimientos cambian</strong>.',
            'Mantener la <strong>simplicidad</strong> en producto y proceso.',
          ] },
          { type: 'p', text: '<strong>Programación Extrema (XP)</strong>, creada por Kent Beck, plantea cuatro prácticas básicas:' },
          { type: 'ul', items: [
            '<strong>Liberación limitada</strong>: entregar rápido aun sin estar completo; lo faltante se incorpora luego.',
            '<strong>Semana laboral de 40h</strong>: sin tiempo extra, para evitar el agotamiento.',
            '<strong>Cliente en el sitio</strong>: su presencia es fundamental para determinar requerimientos.',
            '<strong>Programación en pares</strong>: dos programadores trabajan juntos, más eficiente y eficaz.',
          ] },
          { type: 'p', text: 'En vez de listar funciones, XP describe <strong>escenarios (historias de usuario)</strong>: el cliente describe y prioriza sus necesidades. Las historias se dividen en tareas, se planifican, desarrollan, prueban y entregan; el cliente evalúa la entrega y el proceso se repite para las siguientes historias.' },
          { type: 'p', text: '<strong>Scrum</strong> es un proceso ágil enfocado en <strong>agregar valor al negocio en el menor tiempo posible</strong>, con desarrollo <strong>iterativo e incremental</strong>. Avanza por ciclos llamados <strong>sprints</strong> de <strong>una a cuatro semanas</strong>: el equipo <strong>multidisciplinar y autogestionado</strong> selecciona requisitos de una <strong>lista priorizada</strong> y se compromete a concluirlos. Equipo, calidad y alcance se mantienen inalterables. Se centra en la <strong>gestión</strong>, no en la ingeniería.' },
          { type: 'p', text: '<strong>Los tres roles de Scrum:</strong>' },
          { type: 'table', headers: ['Rol', 'Responsabilidad'], rows: [
            ['Product Owner', 'Única persona responsable de administrar el product Backlog y asegurar que el equipo agregue valor. Define las prioridades de las funcionalidades; sus decisiones se respetan.'],
            ['Equipo', 'Construye el producto en los sprints. Multidisciplinario y autogestionado, sin líder ni jerarquías; roles intercambiables. Cantidad: siete personas, más o menos dos.'],
            ['Scrum Master', 'Ayuda al equipo y la organización a usar Scrum. No es el jefe: hace coaching para lograr productividad y resuelve impedimentos.'],
          ] },
          { type: 'callout', tone: 'warning', text: 'El Scrum Master y el Product Owner NUNCA pueden ser la misma persona.' },
          { type: 'callout', tone: 'criollo', text: 'Ágil = entregas rápidas e incrementales, cliente metido y requisitos que cambian; XP suma cuatro prácticas e historias de usuario, y Scrum laburás por sprints con PO, Equipo y Scrum Master (que nunca son la misma persona).' },
        ] },
      ],
    },
    {
      ...
      sections: [
        {
          ...
          title: 'Modelado de los procesos de negocio',
          blocks: [
            { type: 'h3', text: '¿Qué es modelado? ¿Por qué modelamos?' },
            { type: 'p', text: 'Un <strong>modelo</strong> es una <strong>representación de la realidad o una porción de ella</strong>, que busca representar la apariencia y el comportamiento de lo modelado. Se construye con <strong>mecanismos de abstracción</strong> que realzan los detalles importantes y minimizan los irrelevantes. Según <strong>Alan Davis</strong>, sirve para responder a un <strong>conjunto bien definido de preguntas</strong> sobre la realidad modelada, dentro de una <strong>tolerancia adecuada</strong> al propósito.' },
            { type: 'h3', text: 'Características de los modelos' },
            { type: 'ul', items: [
              'No es la realidad modelada, sino la realidad que se está modelando.',
              'Respeta una cierta \'forma\' de construcción.',
              'Permite mostrar o predecir características de la realidad que modela.',
            ...
            { type: 'callout', tone: 'info', text: 'Trabajar con modelos permite detectar errores en forma temprana y ajustar el diseño cuando sea necesario.' },
            { type: 'h3', text: 'Modelado del negocio' },
            { type: 'p', text: 'El <strong>modelo de negocio</strong> es una <strong>descripción de los procesos de una empresa</strong> (por ejemplo, en un banco: cuentas, inversiones, préstamos). Ayuda a <strong>comprender el negocio del cliente</strong> para recomendar qué informatizar o entender cómo acoplar nuevas funcionalidades a lo existente.' },
            { type: 'h3', text: 'Diagrama de actividad' },
            { type: 'p', text: 'Una forma de modelar el proceso de negocio es el <strong>diagrama de actividad</strong>, útil para comprender el <strong>comportamiento de alto nivel</strong> sin entrar en detalles internos. Es parecido a un diagrama de flujo, pero su <strong>diferencia fundamental</strong> es que puede mostrar <strong>procesamiento en paralelo</strong>. Detalla cómo se ejecutan las acciones, cuándo y qué rol las realiza.' },
            { type: 'h3', text: 'Usos más comunes' },
            { type: 'ul', items: [
              'Describir las acciones de una operación y cómo afectan a los objetos sobre los que actúan.',
              'Mostrar cómo un caso de uso se realiza en términos de los pasos de sus escenarios.',
              'Representar cómo funciona un dominio (roles, tareas, organización).',
              'Describir la dinámica de procesos concurrentes.',
            ] },
            { type: 'h3', text: 'Elementos que lo componen' },
            { type: 'table', caption: 'Elementos del diagrama de actividad', headers: ['Elemento', 'Descripción'], rows: [
              ['Estado inicial', 'Círculo pintado de negro en su interior.'],
              ['Estado final', 'Círculo con un punto en el centro de su interior.'],
              ['Actividad', 'Genera un cambio en el sistema o retorna un valor. Caja de extremos redondeados con su descripción.'],
              ['Transición', 'Salida de una actividad e ingreso a otra. Líneas con flechas; pueden llevar condición de guarda entre corchetes.'],
              ['Decisión', 'Flujos alternativos. Rombo con una o más entradas y dos o más salidas, cada una con guarda de exclusión mutua.'],
              ['Barra de sincronización', 'Split: una transición se divide en hilos paralelos. Merge: espera que todos los hilos activos lleguen para generar las salidas.'],
            ] },
            { type: 'callout', tone: 'info', text: 'Conviene dividir las actividades en carriles (swimlanes), donde cada carril indica quién es el responsable de las actividades que aparecen.' },
            { type: 'h3', text: 'Fortalezas y debilidades' },
            { type: 'p', text: 'Su principal aporte es <strong>modelar el comportamiento paralelo</strong>, adecuado para flujo de trabajo (<em>workflow</em>) y programación multihilo (<em>multi-thread</em>). Su <strong>desventaja</strong>: no muestra con claridad los enlaces entre acciones y objetos, para lo cual es más apropiado el <strong>diagrama de secuencia</strong>. Conviene combinarlo con otras técnicas.' },
            { type: 'h3', text: 'BPM (Business Process Model)' },
            { type: 'p', text: 'Según la guía <strong>CBOK</strong> (Common Body of Knowledge) de la <strong>ABPMP</strong>, <strong>Business Process Management (BPM)</strong> es un enfoque sistemático para identificar, levantar, documentar, diseñar, ejecutar, medir y controlar procesos manuales y automatizados, con el fin de lograr de forma consistente los objetivos de negocio alineados con la estrategia de la organización. Originado en los <strong>workflows tradicionales</strong>, ofrece ventajas:' },
            { type: 'ul', items: [
              'Acota el ámbito a los requerimientos de negocio: los expertos modelan los procesos y IT provee la infraestructura para ejecutarlos.',
              'Aumenta la flexibilidad y agilidad separando la lógica del proceso de otras reglas de negocio.',
              'Reduce costos de desarrollo con lenguajes gráficos de alto nivel.',
              'Permite definir, administrar y ejecutar los procesos como un activo corporativo.',
            ] },
            { type: 'h3', text: 'BPMN (Business Process Model and Notation)' },
            { type: 'p', text: 'El <strong>BPMN</strong> fue una iniciativa del Grupo de Gestión de Procesos, luego integrada al <strong>OMG</strong> (Object Management Group). Su primera versión se liberó en <strong>mayo de 2004</strong> y la vigente es <strong>BPMN 2.0</strong> (de 2009). Su objetivo es una notación <strong>comprensible tanto para profesionales del negocio como para Ingenieros de Software</strong>, aportando un <strong>lenguaje común</strong> entre el diseño de procesos y su implementación. Es simple de aprender y fácil de leer, aún para no expertos.' },
            { type: 'h3', text: 'Categorías de elementos gráficos de BPMN' },
            { type: 'ul', items: [
              '<strong>Elementos de flujo</strong>: eventos, actividades, gateways.',
              '<strong>Elementos de conexión</strong>: flujo de secuencia, flujo de mensaje, asociación.',
              '<strong>Contenedores</strong> (swimlanes): pool, lane.',
              '<strong>Artefactos</strong>: objetos de datos, grupo, anotación.',
            ] },
            { type: 'callout', tone: 'criollo', text: 'Modelás para entender el negocio antes de tocar código: el diagrama de actividad muestra el flujo (y lo paralelo), BPM gestiona los procesos y BPMN 2.0 es la notación gráfica estándar que entienden todos.' },
          ],
        },
      ],
    },
    {
      unit: '5',
      sections: [
        { id: '5.1', title: 'La entrevista', blocks: [
          { type: 'p', text: 'La <strong>extracción de requerimientos</strong> es el primer paso del desarrollo. El apunte cubre tres técnicas básicas.' },
          { type: 'ul', items: [
            '<strong>Entrevista</strong>: conversación dirigida con un propósito específico.',
            '<strong>Cuestionario</strong>: preguntas con un objetivo particular.',
            '<strong>Observación directa</strong>: visita presencial para ver cómo se ejecuta el trabajo.',
          ] },
          { type: 'p', text: 'La <strong>entrevista</strong> sirve para la recopilación de información en formato de <strong>preguntas y respuestas</strong>. Busca opiniones sobre el sistema actual, pero también las <strong>metas</strong>, los <strong>procedimientos formales e informales</strong> y la <strong>cultura</strong> de la organización.' },
          { type: 'p', text: 'En la preparación hay que definir: el motivo de la entrevista, qué preguntas se harán, a quién se entrevistará, y prever que sea exitosa para ambas partes.' },
          { type: 'ul', items: [
            '<strong>Abiertas</strong>: el entrevistado se explaya. Ej.: ¿podría explicarme el proceso de reposición?',
            '<strong>Cerradas</strong>: acotan la respuesta (sí/no o un dato puntual). Ej.: ¿solicitan presupuesto a proveedores?',
            '<strong>De sondeo o exploratorias</strong>: amplían o clarifican. Ej.: ¿por qué? ¿Puede darme un ejemplo?',
          ] },
          { type: 'table', headers: ['Tipo', 'Ventajas', 'Desventajas'], rows: [
            ['Abiertas', 'Muestran el vocabulario del entrevistado, le permiten explayarse, dan riqueza y detalle.', 'El entrevistador puede perder el control con información irrelevante.'],
            ['Cerradas', 'Acortan el tiempo al ir rápido al punto.', 'Se pierde detalle e ideas importantes; pueden aburrir.'],
          ] },
          { type: 'p', text: 'Pasos de la planificación:' },
          { type: 'ol', items: [
            '<strong>Lectura de antecedentes</strong>: investigar la organización y al entrevistado, y familiarizarse con el vocabulario del negocio.',
            '<strong>Determinar los objetivos</strong>: entre <strong>cuatro y seis puntos principales</strong> a cubrir.',
            '<strong>Seleccionar a quién entrevistar</strong>: incluir todos los niveles involucrados; puede hacerse un muestreo.',
            '<strong>Preparación del entrevistado</strong>: avisar con anticipación; duración máxima de 45 minutos a una hora.',
            '<strong>Determinar tipo y estructura de preguntas</strong>: cubrir lo más relevante, sabiendo que es un proceso dinámico.',
          ] },
          { type: 'table', headers: ['Estructura', 'Enfoque', 'Cómo es'], rows: [
            ['Piramidal', 'Inductivo', 'Para el entrevistado poco participativo. Inicia con cerradas y luego amplía con abiertas.'],
            ['Embudo', 'Deductivo', 'Comienza con abiertas generales y reduce con cerradas. Para el que necesita expresarse.'],
            ['Diamante', 'Combinada', 'Cerradas específicas, luego abiertas generales, y cierra con cerradas específicas.'],
          ] },
          { type: 'p', text: 'El <strong>registro</strong> puede ser por grabación (más detalle, libera de tomar notas y mejora el contacto visual), pero si el entrevistado se pone nervioso o cambia su actitud conviene dejar de grabar y tomar notas.' },
          { type: 'callout', tone: 'criollo', text: 'Regla rápida: pirámide = cerrado y abre (para el callado); embudo = abierto y cierra (para el que se desahoga); diamante = cierra, abre, cierra.' },
        ] },
        { id: '5.2', title: 'Cuestionarios, observación directa y recomendaciones', blocks: [
          { type: 'p', text: 'Los <strong>cuestionarios</strong> permiten recoger <strong>opiniones, creencias, posturas, conductas y características</strong> de las personas claves de una organización involucradas en un sistema actual o en uno nuevo.' },
          { type: 'p', text: 'Se emplean para:' },
          { type: 'ul', items: [
            'Entrevistar a personas en ubicaciones separadas.',
            'Conocer la opinión cuando hay muchos involucrados y sería imposible entrevistarlos a todos.',
            'Estudio exploratorio o preliminar antes de iniciar un proyecto.',
            'Sondear problemas del sistema actual para luego darles solución.',
          ] },
          { type: 'p', text: 'Al redactar, la <strong>elección del vocabulario</strong> es clave: el mismo que el del destinatario, específico y con preguntas <strong>cortas pero precisas</strong>. Las importantes van <strong>primero</strong>, pero las de mayor controversia se dejan para el <strong>final</strong>.' },
          { type: 'p', text: 'Formas de aplicar el cuestionario:' },
          { type: 'ul', items: [
            'Reunir a las personas en un espacio para que respondan todas allí.',
            'Entregarlo personalmente y recogerlo cuando esté completo.',
            'Permitir completarlo en horas de trabajo y dejar un buzón de entrega.',
            'Enviarlo por email a filiales lejanas, con fecha límite e instrucciones.',
          ] },
          { type: 'p', text: 'La <strong>observación directa</strong> consiste en recorrer la organización para ver cómo es el trabajo en los sectores afectados, sin limitarse a las respuestas de las entrevistas. Permite identificar relaciones entre decisores y miembros, entender por qué se hace de cierta manera, detectar <strong>procedimientos informales</strong> no documentados y observar <strong>elementos físicos</strong> de la operatoria no detectados antes.' },
          { type: 'p', text: 'Errores a evitar:' },
          { type: 'ul', items: [
            '<strong>Preguntas tendenciosas</strong>: mostrás tu opinión sobre un proceso, lo que limita al entrevistado a exponer otro punto de vista.',
            '<strong>Preguntas dobles</strong>: dos preguntas juntas; el entrevistado puede responder una y omitir la otra, o el entrevistador olvidar que falta parte.',
          ] },
          { type: 'p', text: 'Tanto en entrevistas como en cuestionarios conviene ser <strong>prolijo</strong>, mantener orden y una <strong>secuencia lógica</strong>, cubriendo cada tema sin ir y volver sobre los aspectos.' },
          { type: 'callout', tone: 'criollo', text: 'Los dos pecados: la tendenciosa (le metés tu opinión) y la doble (dos pegadas, se te escapa media respuesta). Ordená con secuencia lógica.' },
        ] },
      ],
    },
    {
      ...
      sections: [
        {
          ...
          title: 'Qué es la ingeniería de requerimientos y por qué hacerla',
          blocks: [
            { type: 'p', text: 'Según <strong>Pfleeger</strong> (<em>Ingeniería de Software. Teoría y práctica</em>), un requerimiento es una <strong>característica del sistema o una descripción de algo que el sistema es capaz de hacer</strong> para satisfacer su propósito. El estándar <strong>IEEE 610-1990</strong> lo define como:' },
            { type: 'ol', items: [
              'Condición o capacidad que <strong>necesita el usuario</strong> para resolver un problema o alcanzar un objetivo.',
              'Condición o capacidad que <strong>debe satisfacer o poseer un sistema</strong> para satisfacer un contrato, estándar, especificación u otro documento formalmente impuesto.',
              'Representación <strong>documentada</strong> de una condición o capacidad como 1 o 2.',
            ] },
            { type: 'p', text: 'La <strong>ingeniería de requerimientos</strong> es el proceso de elaborar las ideas y necesidades iniciales de los usuarios, expresándolas en una <strong>especificación de requerimientos de sistemas</strong>.' },
            { type: 'p', text: 'Sus cuatro etapas:' },
            { type: 'ol', items: [
              '<strong>Extracción</strong>: con entrevistas, cuestionarios, etc.',
              '<strong>Análisis</strong> de toda la información obtenida.',
              '<strong>Especificación</strong> en un documento formal.',
              '<strong>Validación</strong> por el cliente, que confirma si son los requerimientos esperados.',
            ] },
            { type: 'p', text: 'Por qué hacerla: muchos errores se descubren en esta etapa; los detectados más tarde son más costosos; sin especificación se puede obtener el producto incorrecto; y los requerimientos ambiguos generan interpretaciones distintas entre usuarios y desarrolladores.' },
            { type: 'p', text: 'El <strong>Standish Group</strong> analizó <strong>280.000 proyectos</strong> completados en el año 2000 y concluyó:' },
            { type: 'ul', items: [
              'Solo el <strong>28%</strong> se realizaron con éxito.',
              'El <strong>23%</strong> se cancelaron o nunca se implementaron.',
              'El <strong>49%</strong> se completó pero con demoras, sobrecostos o funcionalidades faltantes.',
            ] },
            { type: 'callout', tone: 'warning', text: 'Cuanto más avanzado en el ciclo se detecta el error, mayor el costo de corregirlo. Un error de requerimiento detectado en su fase puede tener costo imperceptible; el mismo error detectado en la fase de prueba puede multiplicar ese costo hasta por 5.000.' },
            { type: 'p', text: '<strong>Causas de problemas en proyectos:</strong>' },
            { type: 'ul', items: [
              '<strong>Requisitos deficientes</strong>, incompletos o cambiantes.',
              'Planificación de agendas y costes <strong>no basada en los requisitos</strong>.',
              'Deficiencias de proceso y <strong>desconocimiento del ciclo de vida</strong>.',
              'Estimaciones <strong>poco realistas</strong>.',
              'Falta de <strong>implicancia del usuario</strong>.',
            ] },
            { type: 'p', text: '<strong>Criterios de un proyecto terminado satisfactoriamente:</strong> sin desviaciones en las <strong>fechas previstas</strong>, se mantuvieron los <strong>costes estimados</strong>, el producto cubrió las <strong>expectativas y necesidades</strong> del cliente y <strong>funcionó correctamente</strong>.' },
            { type: 'callout', tone: 'criollo', text: 'Equivocarte en un papel sale gratis; equivocarte cuando ya está todo programado sale una fortuna.' },
          ],
        },
        {
          id: '6.2',
          title: 'Contexto y límites del sistema, defectos y tipos de requerimientos',
          blocks: [
            { type: 'p', text: 'Una de las cuestiones más difíciles al iniciar el desarrollo es definir los <strong>límites del sistema</strong>: qué cosas son parte del sistema y qué no, y cuáles eventos del entorno deben tener respuesta. Se trabaja con los <strong>stakeholders</strong> para establecer qué es el sistema y qué su entorno. Definir bien los límites permite <strong>calcular tiempos y costos</strong>; si el nuevo sistema reemplaza a uno existente suele ser más sencillo.' },
            { type: 'callout', tone: 'info', text: 'La definición de los límites no es arbitraria: puede verse influenciada por factores técnicos a respetar o por cuestiones económicas (por ejemplo, que ciertos requerimientos o interfaces queden fuera por superar el presupuesto).' },
            { type: 'p', text: 'Es habitual que existan <strong>áreas grises</strong>: cuestiones que no queda claro si están dentro de los límites y que suelen ser motivo de negociación. Se busca <strong>minimizarlas</strong> para evitar inconvenientes posteriores.' },
            { type: 'p', text: 'Todo problema se describe en <strong>dos dominios</strong>:' },
            { type: 'table', headers: ['Dominio', 'Qué representa'], rows: [
              ['Aplicación', 'Donde existe el requerimiento del cliente. Representa el <strong>qué</strong> hay que hacer; permite reconocer el problema.'],
              ['Software', 'Provee la solución interactuando con el dominio de aplicación. Representa el <strong>cómo</strong> se construye el producto.'],
            ] },
            { type: 'p', text: 'Su separación <strong>no es absoluta sino relativa al problema</strong>. El analista trata con distintos dominios como mundos separados, y <strong>todo lo relevante para los requerimientos debe aparecer en alguna parte del dominio de la aplicación</strong>.' },
            { type: 'p', text: '<strong>Problema de la abstracción:</strong> los modelos del software <strong>no son tan tangibles</strong> como el plano de una casa. Aun con prototipos, no es raro que el cliente recién con el producto terminado indique que no cumple sus expectativas. Por eso conviene:' },
            { type: 'ul', items: [
              'Evitar <strong>descripciones genéricas</strong> sin detalle.',
              'Evitar las <strong>ambigüedades</strong>.',
              'Conocer el <strong>entorno del problema</strong>, sin dar nada por supuesto.',
              'Dedicar el <strong>tiempo necesario</strong> a la especificación.',
            ] },
            { type: 'p', text: '<strong>Defectos comunes en los requisitos:</strong>' },
            { type: 'ul', items: [
              '<strong>Cliente/usuarios poco involucrados</strong> en la definición de necesidades.',
              '<strong>Cambios o crecimiento</strong> sin gestionar su impacto en la planificación.',
              'Requisitos <strong>ambiguos</strong>: dos interpretaciones del mismo requerimiento.',
              'Requisitos <strong>innecesarios</strong>: funcionalidades no pedidas que generan costo adicional.',
              'Requisitos <strong>insuficientes</strong>: solo una definición inicial sin detalle.',
              '<strong>Omisión de necesidades</strong> de algún grupo de usuarios con perfiles diferenciados.',
            ] },
            { type: 'p', text: '<strong>Beneficios de los buenos requisitos:</strong> permiten <strong>acuerdo</strong> entre desarrolladores, usuarios y clientes; acordar <strong>criterios de validación</strong>; dan una <strong>base objetiva para estimar recursos</strong>; permiten cumplir los <strong>atributos de calidad</strong> (eficiencia, seguridad); y evitan trabajar a <strong>prueba y error</strong>.' },
            { type: 'p', text: 'La clasificación más usada distingue requerimientos <strong>funcionales</strong> (qué hace) de <strong>no funcionales</strong> (restricciones):' },
            { type: 'table', headers: ['Tipo', 'Descripción', 'Ejemplo'], rows: [
              ['Funcional (de comportamiento)', 'Describe <strong>qué hace</strong> el sistema: entradas, salidas, interacción con el ambiente y comportamiento ante cada estímulo. Define la función de transformación.', 'Registrar pedidos especificando datos de entrada, proceso (controles, verificaciones) y salida válida o inválida.'],
              ['No funcional (de no comportamiento)', 'Describe una <strong>restricción</strong> que limita la elección al construir la solución: performance, plataforma, lenguaje, eficiencia, seguridad, portabilidad.', 'Desarrollarse en arquitectura ARM, o responder consultas dentro de los cinco segundos.'],
            ] },
            { type: 'callout', tone: 'criollo', text: 'Funcional = QUÉ hace el sistema; no funcional = CÓMO de bien lo hace y bajo qué restricciones (rápido, seguro, en tal plataforma).' },
          ],
        },
      ],
    },
    {
      unit: '7',
      sections: [
        { id: '7.1', title: 'Especificación de requerimientos (SRS)', blocks: [
          { type: 'p', text: 'La <strong>especificación de requerimientos de software</strong> (SRS: <em>Software Requirement Specification</em>) contiene una descripción completa del <strong>comportamiento externo</strong> del software para un producto, programa o conjunto de programas. Deben especificarse tanto requerimientos <strong>funcionales como no funcionales</strong>.' },
          { type: 'p', text: 'Dos estrategias para escribirlo: completar el análisis del problema y luego redactar el SRS, o ir descomponiendo el problema y escribiendo cada sección a medida que se avanza.' },
          { type: 'p', text: 'Puede redactarlo el <strong>proveedor</strong> (desarrollador) o el <strong>usuario / cliente</strong>, pero lo recomendable es con la participación de ambas partes.' },
          { type: 'p', text: 'Aspectos básicos que el SRS DEBE incluir:' },
          { type: 'ul', items: [
            '<strong>Funcionalidad</strong>: qué debe hacer el software.',
            '<strong>Interfaces externas</strong>: cómo interactúa con usuarios, hardware y otros sistemas.',
            '<strong>Rendimiento</strong>: velocidad, tiempos de respuesta, recuperación, etc.',
          ...
          { type: 'p', text: 'Lo que NO debe incluir:' },
          { type: 'ul', items: [
            '<strong>Requerimientos del proyecto</strong>: costos, cronogramas, fechas de conclusión.',
            '<strong>Diseños</strong>: tienen audiencias diferentes y particionan la documentación.',
            '<strong>Planes de aseguramiento del producto</strong>: administración de configuraciones, plan de pruebas, etc.',
          ] },
          { type: 'p', text: 'El SRS puede servir como <strong>base para un pedido de cotización</strong> a varios proveedores; en ese caso no se detalla tanto cada requerimiento, sino que se describe en forma general para abarcar más alternativas del mercado.' },
          { type: 'p', text: 'Existe un estándar para la especificación: <strong>IEEE Std. 830 – 1998</strong>. En la práctica las organizaciones suelen basarse en él y adaptarlo a sus necesidades.' },
          { type: 'callout', tone: 'criollo', text: 'El SRS describe el "qué" hacia afuera (funcional y no funcional), no el "cómo" ni el "cuánto sale".' },
        ] },
        { id: '7.2', title: 'Cuantificación de los requerimientos', blocks: [
          { type: 'p', text: 'En la etapa de requerimientos no alcanza con saber <strong>qué</strong> hacer: también hay que saber <strong>cuánto</strong>, porque un mismo problema con distintos volúmenes lleva a soluciones distintas. Los volúmenes no siempre son un problema, pero para saberlo deben analizarse (ej.: no es lo mismo procesar 20 autorizaciones por día que 5000 por hora).' },
          { type: 'p', text: 'El <strong>propósito de la cuantificación</strong> es especificar los requerimientos <strong>estáticos</strong> y/o <strong>dinámicos</strong> vinculados al software o a la interacción humana con el software.' },
          { type: 'p', text: 'Requisitos <strong>estáticos</strong> (pueden ir en un apartado bajo el título <code>capacidad</code>):' },
          { type: 'ul', items: [
            'Número de terminales a considerar.',
            'Número de usuarios conectados en simultáneo.',
            'Cantidad y tipo de información que se manejará.',
          ] },
          { type: 'p', text: 'Requisitos <strong>dinámicos</strong>: números de <strong>transacciones</strong>, <strong>tareas</strong> y cantidad de <strong>datos</strong> a procesar dentro de ciertos períodos de tiempo, para condiciones normales y máximas. Todos deben declararse en <strong>condiciones mensurables</strong> (ej.: 95% de las transacciones se procesan en menos de 1 seg).' },
          { type: 'p', text: 'Se pueden armar cuadros para cuantificar las entidades involucradas en el software:' },
          { type: 'table', headers: ['Entidad','Volumen inicial','Crecimiento esperado','Volumen máximo','Condición de obsolescencia'], rows: [
            ['Clientes','150','25 por año','500','1 año sin pedidos'],
            ['Autorizaciones','25','15 por año','3000','2 meses de hecha'],
          ] },
          { type: 'callout', tone: 'criollo', text: 'Con la misma funcionalidad, el volumen te cambia el diseño de la solución. Por eso primero se mide.' },
        ] },
        { id: '7.3', title: 'Requerimientos no funcionales: técnicas', blocks: [
          { type: 'p', text: '<strong>Barry Boehm</strong> estableció en 1976 una <strong>lista jerárquica de cualidades</strong> de un producto de software (árbol de calidad). Es muy completa, pero no todo sistema necesita especificar la lista entera: depende de los requisitos de cada aplicación.' },
          { type: 'p', text: 'Cada caso pide lo suyo: en un <strong>controlador de vuelo</strong> la <strong>confiabilidad</strong> es crítica; en un <strong>juego masivo para niños</strong> quizás lo sea la <strong>portabilidad</strong>. Hay que determinar para cada situación cuáles son los requerimientos críticos, sin generalizar.' },
          { type: 'p', text: 'Los no funcionales refieren a:' },
          { type: 'ul', items: [
            '<strong>Restricciones</strong>: características impuestas por el cliente.',
            '<strong>Atributos de calidad</strong>: propiedades relevantes para los usuarios.',
          ] },
          { type: 'p', text: 'Cuando se especifican, se recomienda un <strong>análisis costo/beneficio</strong>. La correcta descripción se evalúa con el criterio <strong>SMART</strong>:' },
          { type: 'table', headers: ['Término','Significado'], rows: [
            ['Específico (Specific)','Expresado sin ambigüedad, simple y claro.'],
            ['Medible (Measurable)','Se puede medir y probar si lo cumple o no.'],
            ['Alcanzable (Attainable)','Es factible llevarlo a cabo.'],
            ['Realizable (Realizable)','Se puede cumplir con los recursos disponibles: infraestructura, tecnología, personal, etc.'],
            ['Rastreable (Traceable)','Se puede determinar su origen, quién lo solicitó, dónde se especifica, su diseño e implementación.'],
          ] },
          { type: 'p', text: 'Para <strong>validar</strong> un requerimiento se emplea la <strong>definición de escenarios</strong>:' },
          { type: 'ul', items: [
            '<strong>La entrada</strong>: quién produce el estímulo y el estímulo que se produce.',
            '<strong>Las condiciones</strong>: en qué estado está el sistema y qué componente recibe el estímulo.',
            '<strong>Los resultados</strong>: la respuesta que provoca el estímulo y la métrica para medirlo.',
          ] },
          { type: 'callout', tone: 'criollo', text: 'Boehm para saber qué cualidades existen, SMART para escribir sin ambigüedad, escenarios para validar, y siempre costo/beneficio atrás.' },
        ] },
        { id: '7.4', title: 'Atributos de una buena especificación', blocks: [
          { type: 'p', text: 'Atributos que debe cumplir una <strong>SRS</strong> para considerarse bien escrita, cada uno apuntando a una propiedad distinta del documento.' },
          { type: 'p', text: '<strong>Correcto</strong>: si, y solo si, cada requisito indicado representa algo requerido por el sistema. No hay herramienta que garantice la corrección; se recomienda que el <strong>cliente</strong> valide que la especificación refleja sus necesidades.' },
          { type: 'p', text: '<strong>No ambigua</strong>: si, y solo si, cada requerimiento tiene una <strong>única interpretación</strong>. Todo término con múltiples significados debe ir en un <strong>glosario</strong>.' },
          { type: 'p', text: '<strong>Completa</strong>, si, y solo si, incluye:' },
          { type: 'ul', items: [
            'Todo lo que el software tiene que hacer (difícil de lograr: si se olvida, no se detecta fácilmente).',
            'Todas las respuestas a todas las entradas posibles, tanto para datos <strong>válidos</strong> como <strong>inválidos</strong>.',
            'Todas las páginas, figuras y tablas numeradas y referenciadas.',
            'Ninguna sección con la sigla <em>to be determined</em> (a determinar), que marca un requerimiento de descripción incompleta.',
          ] },
          { type: 'p', text: '<strong>Verificable</strong>: si, y solo si, existe un <strong>proceso concreto y finito</strong> para comprobar si el software lo cumple. Los requisitos ambiguos (\'interfaz amigable\'), las cantidades no mensurables o las pruebas de bloqueo no son verificables; si no hay método de comprobación, el requisito se elimina o revisa.' },
          { type: 'p', text: '<strong>Consistente</strong>: si, y solo si, no hay conflictos entre requisitos. Tres tipos: <strong>términos conflictivos</strong> (mismo significado con distintos términos), <strong>características conflictivas</strong> (comportamientos contradictorios) e <strong>inconsistencia temporal</strong> (características temporales contradictorias).' },
          { type: 'p', text: '<strong>Entendible por no especialistas</strong>: la notación formal debe poder comprenderla clientes y usuarios para que puedan validarla.' },
          { type: 'p', text: '<strong>Modificable</strong>: su estilo y estructura permiten incorporar cambios de forma fácil, completa y consistente. Generalmente requiere <strong>tabla de contenidos</strong> e <strong>índice</strong>.' },
          { type: 'p', text: '<strong>Rastreable o trazable</strong>: el origen de cada requerimiento es claro. Tipos: hacia atrás desde los requerimientos (por qué existe cada uno), hacia adelante hasta los requerimientos (documentos previos referenciados al SRS), hacia atrás hasta los requerimientos (cada comportamiento refiere los que satisface) y hacia adelante desde los requerimientos (qué componentes satisfacen cada uno).' },
          { type: 'p', text: '<strong>Anotada</strong>: cada requerimiento lleva una anotación que guía el desarrollo. Dos tipos: <strong>necesidad relativa</strong> (E esencial, D deseable, O opcional) y <strong>estabilidad relativa</strong> (estable o volátil).' },
          { type: 'callout', tone: 'criollo', text: 'Los diez: correcta, no ambigua, completa, verificable, consistente, entendible por no especialistas, modificable, trazable y anotada. Si te acordás de esos, tenés la pregunta.' },
        ] },
        { id: '7.5', title: 'Gestión y evolución de los requerimientos', blocks: [
          { type: 'p', text: 'La <strong>revisión regular</strong> de la definición de los requerimientos ayuda a su mejor gestión y a la <strong>detección de errores</strong>. Participan tanto los <strong>desarrolladores</strong> como el <strong>cliente</strong>.' },
          { type: 'p', text: 'La revisión puede hacerse <strong>formalmente</strong> (con la documentación completa) o <strong>informalmente</strong> durante su producción. Una buena comunicación entre clientes, usuarios y desarrolladores ayuda a prevenir problemas en las primeras etapas.' },
          { type: 'p', text: 'La <strong>validación</strong> la realizan el <strong>cliente y los usuarios</strong>, para confirmar que los requerimientos coinciden con lo que se desea o espera del sistema. Es importante porque los <strong>costos de los errores son altos</strong>: cuanto antes se detectan, más pronto se corrigen. El <em>prototipado</em> es una técnica de gran utilidad para validar.' },
          { type: 'p', text: '<strong>Evolución</strong>: como los objetivos de la organización pueden modificarse, los requerimientos pueden cambiar. Hay que planear los posibles cambios durante el desarrollo y mientras se usa el sistema. Cada cambio se actualiza en el SRS <strong>generando una nueva versión</strong>, por lo que el documento debe organizarse para incorporar cambios fácilmente.' },
          { type: 'callout', tone: 'criollo', text: 'Un error de requerimientos que llega al final sale carísimo; cazado temprano, sale barato. Validar a tiempo es ahorrar plata.' },
        ] },
      ],
    },
    {
      ...
      sections: [
        {
          ...
          title: 'Prototipación de requerimientos y mockups',
          blocks: [
            { type: 'p', text: 'Un <strong>prototipo</strong> es un modelo o maqueta que muestra las interfaces entre el sistema y el usuario. Simula los aspectos más visuales (entradas, salidas, componentes gráficos, conceptos a tratar) y la interactividad con los usuarios, buscando la mayor similitud posible al sistema final.' },
            { type: 'p', text: 'Pautas para desarrollarlo:' },
            { type: 'ul', items: [
              'Definir a qué usuarios va dirigido y responder a sus necesidades.',
              'Emplear conceptos, términos y simbología familiares para los usuarios.',
              'Mantener la coherencia interna y con otros sistemas existentes.',
              'Agrupar las funciones de forma lógica.',
              'Mostrar el estado de la ejecución de las funciones.',
              'Obstaculizar acciones destructivas de datos o información.',
              'Generar diálogos eficientes.',
            ] },
            { type: 'p', text: 'Muchos errores provienen de la <strong>comunicación deficiente</strong> entre usuario y analista al obtener requisitos. Son de los más caros de corregir porque se visualizan en forma tardía y pueden multiplicar varias veces el costo inicial. Los problemas habituales: requerimientos incompletos, ambiguos o inconsistentes entre sí, por lo tanto incorrectos.' },
            { type: 'callout', tone: 'info', text: 'El prototipo es <strong>especialmente útil</strong> cuando los requerimientos cambian rápido, el cliente no entrega una lista completa, o ni el cliente ni el equipo conocen bien el área de aplicación.' },
            { type: 'callout', tone: 'warning', text: 'Principal desventaja: desde el comienzo es imposible saber cuántas iteraciones harán falta hasta lograr un producto aceptable para el cliente.' },
            { type: 'p', text: 'Beneficios del prototipado según Gordon y Bieman (1995), <em>Rapid prototyping: lesson learned</em> (IEEE Software), sobre 39 proyectos:' },
            { type: 'ul', items: [
              'Perfeccionamiento en la usabilidad del nuevo sistema.',
              'Mayor coherencia entre las necesidades de los usuarios y el sistema.',
            ...
            { type: 'p', text: '<strong>Diseño centrado en el usuario</strong>: el proceso arranca por los aspectos más visibles del sistema, trabajando con los usuarios. Su colaboración es clave: el prototipo es la herramienta que permite obtener feedback temprano para acordar los requerimientos.' },
            { type: 'p', text: 'Un <strong>mockup</strong> es una representación visual pero <strong>estática</strong> de un diseño. Muestra cómo se estructura la información, cómo se visualizan los contenidos y las funciones básicas disponibles, pero no simula la interactividad real (eso lo hace el prototipo funcional). Es útil para que equipo y cliente visualicen el diseño y den feedback en las revisiones.' },
            { type: 'callout', tone: 'criollo', text: 'El prototipo es una herramienta más de la gestión de requerimientos, no la solución mágica.' },
          ],
        },
        {
          id: '2',
          title: 'Casos de uso y actores',
          blocks: [
            { type: 'p', text: 'Los casos de uso conducen el desarrollo de software y son una herramienta clave en la definición de requerimientos. Presentados por <strong>Ivar Jacobson en 1987</strong> con el método <strong>OOSE</strong> (Object Oriented Software Engineering), se volvieron base de muchos métodos y forman parte de <strong>UML</strong>. Estudian las interacciones entre el sistema y su entorno, dejando claro qué hará el sistema y, por omisión intencional, qué no hará.' },
            { type: 'callout', tone: 'info', text: '<em>Un caso de uso es una descripción de un conjunto de secuencias de acciones, incluyendo variantes, que ejecuta un sistema para producir un resultado observable de valor para un actor.</em> — Jacobson, Rumbaugh y Booch, p. 193.' },
            { type: 'p', text: 'Gráficamente, el caso de uso se representa como una <strong>elipse</strong> con su nombre adentro, expresado desde el punto de vista de quien lo realiza: <strong>verbo en infinitivo + objeto/entidad principal</strong> (ej.: <code>Registrar préstamo</code>).' },
            { type: 'callout', tone: 'info', text: '<em>Un actor representa un conjunto coherente de roles que juegan los usuarios de los casos de uso al interactuar con estos. Los actores pueden ser personas o sistemas mecánicos.</em> — Jacobson, Rumbaugh y Booch, p. 192.' },
            { type: 'p', text: 'Un <strong>actor</strong> es alguien o algo que interactúa con el sistema: persona, organización, unidad u otro sistema. Se representa como un muñeco de palo.' },
            { type: 'callout', tone: 'warning', text: 'Si el actor es una persona, <strong>nunca</strong> se coloca su nombre sino el <strong>rol</strong> que representa, porque la misma persona puede interactuar desde roles diferentes.' },
            { type: 'p', text: 'Preguntas para identificar actores:' },
            { type: 'ul', items: [
              '¿Quién usa el sistema?',
              '¿Quién necesita que el sistema le brinde información?',
              '¿Quién provee al sistema de información?',
            ...
            { type: 'ul', items: [
              '<strong>Actor primario</strong>: inicia el caso de uso y lo utiliza para lograr un objetivo.',
              '<strong>Actor secundario</strong>: es requerido por el caso de uso (por ejemplo, recibe una notificación o información), pero no lo inicia.',
            ] },
            { type: 'callout', tone: 'warning', text: 'Cada caso de uso puede ser iniciado únicamente por <strong>UN</strong> actor. Si varios pueden iniciarlo, se resuelve con una <strong>relación de herencia entre actores</strong>.' },
            { type: 'callout', tone: 'criollo', text: 'El actor no es siempre una persona: modelás el rol, no el nombre, porque el mismo tipo entra con sombreros distintos.' },
          ],
        },
        {
          id: '3',
          title: 'Descripción, relaciones y diagrama de casos de uso',
          blocks: [
            { type: 'p', text: 'Cada caso de uso es una descripción de las posibles secuencias de interacciones entre el sistema y sus actores externos para alcanzar un objetivo. Como la vista gráfica no alcanza, cada caso cuenta con un <strong>cuadro descriptivo</strong>.' },
            { type: 'table', headers: ['Campo', 'Contenido'], rows: [
              ['Nombre del caso de uso', 'Debe coincidir con el indicado en el diagrama (la elipse)'],
              ['Actor', 'El actor que inicia el caso'],
              ['Precondición', 'Lo que debe ser cierto antes de ejecutar el caso'],
              ['Curso normal', 'Secuencia numerada de lo que hace actor y sistema cuando todo sale bien'],
              ['Curso alternativo', 'Variantes del curso normal, numeradas según el paso donde se desvían (ej.: <code>3.1</code>)'],
            ] },
            { type: 'p', text: 'Procedimiento: identificar el caso (nombre coincide con la elipse), indicar el actor que lo inicia, describir el <strong>curso normal</strong> numerado (acciones de actor y sistema) y, finalmente, los <strong>cursos alternativos</strong> en la segunda columna. Si la alternativa surge en el paso 3, se indica como <code>3.1</code>.' },
            { type: 'p', text: 'El <strong>cuadro descriptivo extendido</strong> suma, respecto del básico: identificador del requerimiento, nombre, actor principal y secundario, descripción, precondición, secuencia normal, <strong>postcondición</strong>, <strong>excepciones</strong> paso a paso (condición, acción y si el caso continúa o aborta), <strong>importancia</strong> y comentarios. No incluye implementación.' },
            { type: 'p', text: 'Las relaciones de <strong>extensión</strong> y <strong>uso</strong> se presentan únicamente <strong>entre casos de uso</strong> (no con actores), y cada parte debe ser un caso de uso por sí misma. Aparecen al refinar el modelo, tras identificar los casos principales.' },
            { type: 'ul', items: [
              '<strong>Extensión</strong>: un caso extiende a otro cuando tiene funcionalidad que no siempre ocurre (podría darse o no, no es error ni excepción). Ejemplo de Jacobson: <em>Cenar</em> extendido por <em>Tomar café</em>.',
              '<strong>Uso (include)</strong>: un caso está incluido en otro porque es funcionalidad común a más de un caso. Ejemplo: <em>Consultar socio</em>, usado por <em>Registrar préstamo</em> y <em>Registrar devolución</em>.',
            ] },
            { type: 'p', text: 'El <strong>diagrama de casos de uso</strong> modela la vista de casos de uso del sistema y muestra el conjunto de casos, los actores y las relaciones. Puede usarse un rectángulo para indicar la <strong>frontera</strong> entre sistema y entorno (con el nombre del sistema en un borde interno) y cajas rectangulares más pequeñas para agrupar casos por subsistemas.' },
            { type: 'callout', tone: 'criollo', text: 'Extensión es lo que podría pasar (el cafecito); uso es lo que comparten varios casos (consultar socio). Y ambas SOLO entre casos de uso, nunca con actores.' },
          ],
        },
        {
          id: '4',
          title: 'Historias de usuario, INVEST y épicos',
          blocks: [
            { type: 'p', text: 'Para comprender un caso de uso, narramos <strong>historias</strong>: cubren cómo se alcanza el objetivo del caso en forma exitosa y cómo se maneja cualquier problema en el camino. Permiten implementar el caso <strong>porción por porción</strong> en lugar de todo de una vez.' },
            { type: 'p', text: 'Los <strong>casos de uso 2.0</strong> de Jacobson buscan alivianar el proceso con narrativas más ligeras, que capturen lo estrictamente necesario para generar historias de usuario (incluso en tarjetas pequeñas), bajando detalle solo en los casos que lo requieran. No reemplazan a los casos de uso clásicos. (El apunte ilustra esto con un esquema de tarjetas que avanzan por etapas.)' },
            { type: 'p', text: 'Una <strong>historia de usuario</strong> es la descripción breve de una funcionalidad desde el punto de vista del usuario o cliente, idealmente hasta dos oraciones en una tarjeta. Responde tres preguntas:' },
            { type: 'ul', items: [
              '<strong>¿Quién es el beneficiario?</strong> Los interesados/actores que se benefician.',
              '<strong>¿Qué se quiere hacer?</strong> La funcionalidad a alto nivel.',
              '<strong>¿Cuál es el beneficio?</strong> El por qué / valor de negocio.',
            ] },
            { type: 'callout', tone: 'info', text: 'Formato recomendado: <em>Como (rol) yo quiero (algo) para (beneficiarme)</em>.' },
            { type: 'p', text: 'Un <strong>épico</strong> es una historia tan grande que difícilmente pueda implementarse en una única iteración; debe <strong>desagregarse</strong> en historias de usuario menores.' },
            { type: 'p', text: 'Atributos de una buena historia según el criterio <strong>INVEST</strong> (Bill Wake, 2003):' },
            { type: 'table', headers: ['Letra', 'Atributo', 'Significado'], rows: [
              ['I', 'Independiente', 'Autosuficiente, sin dependencia de otra historia.'],
              ['N', 'Negociable', 'Puede cambiarse hasta tanto sea parte de una iteración.'],
              ['V', 'Valorable', 'Debe entregar valor al cliente o usuario final.'],
              ['E', 'Estimable', 'Siempre debería poder estimarse su esfuerzo.'],
              ['S', 'Pequeña (Small)', 'Nunca tan grande como para no poder planificarse o priorizarse.'],
              ['T', 'Comprobable (Testable)', 'Debe brindar la información necesaria para probar su desarrollo efectivo.'],
            ] },
            { type: 'callout', tone: 'criollo', text: 'Si la historia no te entra en una iteración, es un épico: partila hasta que sea INVEST.' },
          ],
        },
      ],
    },
    {
      unit: '9',
      sections: [
        { id: '5', title: 'Trazabilidad de requerimientos', blocks: [
          { type: 'p', text: 'La trazabilidad parte del <strong>SRS</strong> (Software Requirement Specification) e identifica de forma clara dónde se originó cada requerimiento, para poder referenciarlo en las futuras etapas del desarrollo.' },
          { type: 'p', text: 'Cuando el producto pasa a ser operado y mantenido, la trazabilidad remota cobra más importancia: al modificar diseño o código es fundamental identificar los requerimientos afectados para actualizarlos.' },
          { type: 'p', text: 'La <strong>trazabilidad remota</strong> referencia el origen o fuente del requerimiento (fases previas al desarrollo). La <strong>trazabilidad futura</strong> apunta a las fases posteriores, para lo cual cada requerimiento debe tener un nombre o referencia única.' },
          { type: 'table', headers: ['Tipo', 'Qué permite'], rows: [
            ['Hacia atrás desde los requerimientos', 'Conocer por qué cada requerimiento del SRS existe.'],
            ['Hacia adelante hasta los requerimientos', 'Los documentos previos al SRS pueden referenciarse al SRS.'],
            ['Hacia atrás hasta los requerimientos', 'Cada comportamiento del software refiere explícitamente los requerimientos que satisface.'],
            ['Hacia adelante desde los requerimientos', 'Entender qué componentes del software satisfacen cada requerimiento.'],
          ] },
          { type: 'callout', tone: 'criollo', text: '"Desde los requerimientos" = arrancás en el requerimiento; "hasta los requerimientos" = llegás al requerimiento. Atrás/adelante te dice si vas a fases previas o posteriores.' },
        ] },
        { id: '6', title: 'Verificación, validación y pruebas de aceptación', blocks: [
          { type: 'p', text: 'Según Boehm (1979): <strong>Validación</strong> = ¿estamos construyendo el producto correcto? · <strong>Verificación</strong> = ¿estamos construyendo el producto correctamente?' },
          { type: 'p', text: 'La <strong>validación</strong> demuestra que la definición de requerimientos generada se corresponde con el sistema que el usuario o cliente necesita; por eso es clave que el cliente valide la especificación, corroborando que no contenga errores ni inconsistencias. La <strong>verificación</strong> comprueba que el software cumple con la especificación previamente generada.' },
          { type: 'p', text: 'La tarea de revisión y pruebas se denomina <strong>V&amp;V</strong> y se aplica en cada etapa: inicia con la comprobación de los requerimientos, luego el diseño, el código y finalmente el producto final.' },
          { type: 'p', text: 'La <strong>prueba de aceptación</strong> la realizan los usuarios para verificar que el sistema se ajusta a sus requerimientos. Es de tipo <strong>caja negra</strong> y sus casos de prueba se basan en la especificación de requerimientos.' },
          { type: 'ul', items: [
            'Determinar el rol del usuario.',
            'Definir los criterios de aceptación.',
            'Desarrollar un plan de aceptación.',
          ...
          { type: 'callout', tone: 'warning', text: 'En la aceptación se trabaja con <strong>datos reales del cliente</strong>, no ficticios. Eso puede disparar errores no detectados antes, tanto en el sistema como en los requerimientos.' },
          { type: 'p', text: 'Según el <strong>ISTQB</strong>, las pruebas de aceptación son pruebas formales respecto a las necesidades del usuario, los requisitos y los procesos comerciales, para determinar si el sistema cumple los criterios de aceptación y permitir que el usuario, cliente u otra entidad autorizada decida si lo acepta.' },
          { type: 'p', text: 'Las pruebas de aceptación basadas en los requerimientos parten de los requerimientos documentados para diseñar pruebas que comprueben si el sistema los cumple. Son <strong>pruebas de validación</strong>, no de defectos: buscan demostrar que el sistema implementó correctamente los requerimientos.' },
          { type: 'callout', tone: 'criollo', text: 'Para "consultar datos de un producto indicando un dato", las pruebas son: buscar un producto que exista, uno que no exista, y un dato que coincida con varios productos.' },
        ] },
        { id: '7', title: 'Estrategias de prueba y testing ágil', blocks: [
          { type: 'p', text: 'La <strong>estrategia de prueba</strong> define el enfoque y los objetivos generales de las actividades de prueba. Debe incluir las fases de prueba a seguir y qué clases de prueba se realizarán en cada una.' },
          { type: 'table', headers: ['Fase', 'Qué prueba', 'Quién/cómo'], rows: [
            ['De unidad', 'Un módulo o componente.', 'Generalmente lo realiza quien lo construyó.'],
            ['De integración', 'Respuestas de grupos de módulos interconectados.', 'Detecta fallos en la interacción entre componentes.'],
            ['De sistema', 'El sistema completo en un ambiente similar al real.', 'Considerar que puede ser parte de un sistema mayor.'],
          ] },
          { type: 'p', text: 'Tipos (opciones) de prueba sobre el sistema:' },
          { type: 'ul', items: [
            'De recuperación.',
            'De seguridad.',
            'De resistencia o stress.',
          ...
          { type: 'p', text: 'La estrategia debe contemplar las técnicas y herramientas a utilizar y los criterios de satisfacción y finalización. La fase de prueba se centra en asegurar que el sistema cumpla todos los requerimientos definidos, por lo que sus criterios se basan en la definición de requisitos.' },
          { type: 'p', text: 'El <strong>testing ágil</strong> es una práctica de prueba en proyectos ágiles que incorpora técnicas como la <strong>programación extrema (XP)</strong> y enfatiza el paradigma de <strong>diseño de prueba primero</strong> (ISTQB). Las pruebas las diseña el equipo de desarrollo durante el análisis. El equipo mantiene comunicación continua y rota roles para eliminar la dependencia entre individuos; <strong>todos los individuos tienen habilidades de probadores</strong>.' },
          { type: 'p', text: 'El <strong>probador ágil</strong>, además de habilidades técnicas en testing, integra las necesidades del interesado al equipo, define las historias de usuario en requisitos y las transforma en parámetros de prueba al codificar, colaborando con todos los integrantes.' },
          { type: 'table', headers: ['Rol', 'Descripción'], rows: [
            ['Tester', 'Persona del equipo que puede desempeñar varios roles; tiene habilidades para desarrollar y ejecutar pruebas.'],
            ['Interesado', 'Persona o entidad que se apoya en un analista para proponer una solución a un problema; elabora el discurso de los requisitos.'],
            ['Equipo ágil', 'Personas expertas en software y en el dominio del negocio que trabajan hacia un mismo fin en pequeños ciclos de tiempo (iteraciones).'],
          ] },
          { type: 'callout', tone: 'info', text: 'Cuando todos los miembros del equipo son probadores, <strong>desaparece la fase de pruebas</strong> que existía en los métodos tradicionales.' },
          { type: 'p', text: 'El diseño de pruebas y las herramientas adecuadas son vitales para asegurar la calidad. La planeación importa para distribuir tiempo en testing particular, arreglar bugs y realizar otras pruebas (aceptación, regresión, etc.).' },
          { type: 'callout', tone: 'criollo', text: 'El factor de éxito del testing ágil es automatizar las pruebas de regresión (aseguran calidad en todo el comportamiento del sistema) y también las de aceptación (aseguran al cliente la funcionalidad que pidió).' },
        ] },
      ],
    },
    {
      unit: '10',
      sections: [
        { id: '8', title: 'Diagrama de secuencia y objetos del modelo de análisis', blocks: [
          { type: 'p', text: 'El <strong>diagrama de secuencia</strong> muestra la interacción entre objetos desde un punto de vista temporal: describe cómo colaboran un grupo de objetos para realizar una actividad y atrapa el comportamiento de un caso de uso en particular.' },
          { type: 'ul', items: [
            'Muestra la interacción entre objetos desde un punto de vista temporal.',
            'Describe cómo colaboran un grupo de objetos para realizar una actividad.',
            'Atrapa el comportamiento descripto por un caso de uso particular.',
            'Representa la secuencia de mensajes (con emisor y receptor) para realizar una tarea.',
          ] },
          { type: 'p', text: 'El <strong>modelo de análisis</strong> se desarrolla una vez aprobado el modelo de requerimientos. Estructura el sistema de forma independiente del ambiente de implementación, enfocándose en su estructura lógica. Describe el sistema con tres tipos de objetos, usados en el diagrama de secuencia de esta etapa:' },
          { type: 'ul', items: ['Objeto de interfaz', 'Objetos de entidad', 'Objetos de control'] },
          { type: 'p', text: '<strong>Objetos de interfaz:</strong> permiten la comunicación entre los actores y el sistema (y viceversa). Los casos de uso especifican esa interacción con el ambiente, por lo que se identifican fácilmente leyendo la descripción del caso de uso.' },
          { type: 'p', text: '<strong>Objetos de entidad:</strong> modelan la información que el sistema debe manejar a lo largo del tiempo, información que sobrevive a los casos de uso. Se identifican rápidamente, suelen ser obvios y generalmente se corresponden a conceptos del mundo real, aunque no siempre.' },
          { type: 'p', text: '<strong>Objetos de control:</strong> modelan la funcionalidad que no se asigna naturalmente a otros objetos (no es interfaz ni información). Operan sobre varios objetos entidad, hacen alguna operación y retornan el resultado a un objeto de interfaz.' },
          { type: 'callout', tone: 'criollo', text: 'El flujo del análisis va entidades → control → interfaz: el actor habla siempre con la interfaz, nunca directo con el control.' },
        ] },
        { id: '9', title: 'Línea de vida, mensajes, actividad, recursión, condición e iteración', blocks: [
          { type: 'p', text: '<strong>Línea de vida:</strong> cada objeto posee una línea vertical por debajo que representa su existencia en el tiempo dentro del diagrama.' },
          { type: 'p', text: '<strong>Mensajes:</strong> cada mensaje es una flecha del emisor al receptor.' },
          { type: 'ul', items: [
            'Se representan con una flecha desde el emisor al receptor.',
            'El orden temporal está dado por la altura: las flechas más altas se ejecutan antes que las de abajo.',
            'Cada flecha lleva el nombre del mensaje (puede incluir parámetros, restricciones, valor de retorno).',
          ] },
          { type: 'p', text: '<strong>Período de actividad:</strong> tiempo que tarda un objeto en ejecutar una acción. Se representa con espacios rectangulares sobre la línea de vida.' },
          { type: 'p', text: '<strong>Mensajes recursivos:</strong> un objeto se manda un mensaje a sí mismo. Se representan duplicando un rectángulo de actividad, por lo que el objeto aparece como si estuviera varias veces activado.' },
          { type: 'p', text: '<strong>Condición:</strong> el mensaje solo se ejecuta si la condición es verdadera. Se escribe entre corchetes antes del nombre del mensaje y puede expresarse en lenguaje coloquial, por ej.: <code>[hay producto]</code>.' },
          { type: 'p', text: '<strong>Iteración:</strong> se nota con <code>*</code> previo a la condición. Notación: <code>*[condición] Mensaje</code>, lo que significa que la acción se repite mientras la condición sea verdadera.' },
          { type: 'p', text: 'El apunte cierra con un diagrama de secuencia completo de un caso de uso de checkout en tienda online (Online Customer, Shopping Cart, Checkout, Cart, Cart Item, Order Summary, Process Order), que integra actores, interfaces, control, entidades, mensajes con orden, períodos de actividad e iteración. Extraído de J. Conallen (1999), <em>Building Web Applications with UML</em>, Addison Wesley, Cap. 9.' },
          { type: 'callout', tone: 'criollo', text: 'Regla mnemotécnica: <code>*</code> es iteración, los corchetes son condición; no los mezcles.' },
        ] },
        { id: '10', title: 'Diagrama de colaboración y diagramas de interacción', blocks: [
          { type: 'p', text: 'El <strong>diagrama de colaboración</strong> muestra la misma información que el de secuencia; la diferencia es solo gráfica.' },
          { type: 'ul', items: [
            'Muestran la misma información que un diagrama de secuencia.',
            'Diferencia gráfica: los objetos se representan únicos con <strong>links</strong> entre ellos y los mensajes van sobre los links, pero acá es necesario <strong>numerar los mensajes</strong> para indicar la secuencia de ejecución (no hay eje temporal por altura).',
            'La selección (condición) y la iteración se denotan igual que en el diagrama de secuencia.',
          ] },
          { type: 'p', text: 'El ejemplo de colaboración (OnlineCustomer, ShoppingCart, Checkout, Cart, CartItem, OrderSummary, ProcessOrder) usa links y mensajes numerados del 1 al 12. Extraído de J. Conallen (1999), <em>Building Web Applications with UML</em>, Addison Wesley, Cap. 9.' },
          { type: 'p', text: 'Existen dos tipos de <strong>diagramas de interacción</strong>:' },
          { type: 'ul', items: ['Diagramas de secuencia', 'Diagramas de colaboración'] },
          { type: 'callout', tone: 'info', text: 'El usuario elige cuál emplear. Ambos describen lo mismo desde ángulos distintos: secuencia enfatiza el tiempo (altura de las flechas), colaboración enfatiza la estructura (links entre objetos).' },
          { type: 'callout', tone: 'criollo', text: 'Misma película, dos montajes: si querés ver el orden cronológico tirá secuencia; si querés ver quién se conecta con quién, colaboración.' },
        ] },
      ],
    },
    {
      unit: '11',
      sections: [
        { id: '11', title: 'Definiciones y tipos de sistemas', blocks: [
          { type: 'p', text: 'Un sistema es un <strong>conjunto de elementos que se relacionan para alcanzar un fin</strong>. La definición es amplia: no exige computadoras ni software.' },
          { type: 'p', text: 'Un <strong>sistema de información</strong> es el que logra un resultado empresarial: recopila, manipula, almacena y crea reportes de la información de las actividades de negocio, para ayudar a la administración en el manejo de las operaciones (Schach).' },
          { type: 'p', text: 'Existen diversas clasificaciones de sistemas, pero el apunte se enfoca en tres:' },
          { type: 'ul', items: [
            'Sistemas de tiempo real',
            'Sistemas distribuidos',
            'Sistemas embebidos',
          ] },
          { type: 'callout', tone: 'criollo', text: 'Sistema es cualquier cosa con un fin; sistema de información es el que le sirve al negocio. No los mezcles.' },
        ] },
        { id: '12', title: 'Sistemas de tiempo real', blocks: [
          { type: 'p', text: 'Un sistema de tiempo real interactúa con el entorno y debe responder en el tiempo dictado por el problema. El intervalo entre entrada y salida suele ser muy pequeño para ser aceptable.' },
          { type: 'p', text: 'Su eficiencia no depende solo de la exactitud del cómputo, sino también del momento en que entrega el resultado. La <strong>predictibilidad</strong> es su característica principal.' },
          { type: 'p', text: 'Es más complejo de lo que se cree: hay que tener presentes todas las interacciones entre componentes, porque cualquier cambio puede generar alteraciones impensadas en los tiempos.' },
          { type: 'p', text: '<strong>Fases del diseño:</strong>' },
          { type: 'ol', items: [
            'Identificar todas las tareas y las restricciones temporales que se deben cumplir.',
            'Codificar los programas que ejecutarán las tareas.',
            'Medir el tiempo de cómputo de cada tarea y analizar la planificación.',
          ] },
          { type: 'p', text: '<strong>Generalidades:</strong>' },
          { type: 'ul', items: [
            'Requiere técnicas de análisis, diseño y prueba poco usuales en otras áreas.',
            'Se acopla al mundo externo.',
            'Opera en condiciones de rendimiento muy rigurosas.',
            'Se ve afectado por: hardware, software, sistema operativo, requisitos de aplicación y aspectos del diseño.',
            'Su uso más habitual fue el control de entornos, a veces con sensores que procesan la entrada y generan una salida en respuesta.',
          ] },
          { type: 'p', text: '<strong>Elementos que lo componen (STR):</strong>' },
          { type: 'ul', items: [
            'Aspectos de integración y de rendimiento.',
            'Manejo de interrupciones.',
            'Bases de datos de tiempo real.',
          ...
          { type: 'callout', tone: 'info', text: 'Los SOTR son la plataforma del STR: no importa el usuario, sino los procesos. Ejemplos: VxWorks, Solaris, Lynx OS y Spectra.' },
          { type: 'callout', tone: 'criollo', text: 'Acá no alcanza con tener razón: tenés que tenerla a tiempo, o no sirvió.' },
        ] },
        { id: '13', title: 'Sistemas distribuidos', blocks: [
          { type: 'callout', tone: 'info', text: '"Un sistema distribuido es un sistema en el que el procesamiento de información se distribuye sobre varias computadoras en vez de estar confinado en una única máquina. En la actualidad, prácticamente todos los grandes sistemas informáticos son sistemas distribuidos." — Sommerville (2005).' },
          { type: 'p', text: 'Se conforma con un grupo de computadoras separadas físicamente, cada una con su hardware y software individual, conectadas por una red de comunicaciones. En el diseño se evalúa como un sistema único, pero con múltiples destinatarios.' },
          { type: 'p', text: 'Al ser una red con varias computadoras, <strong>el fallo de una no implica el fallo del sistema completo</strong>.' },
          { type: 'p', text: '<strong>Ventajas:</strong>' },
          { type: 'ul', items: [
            'Permite compartir hardware y software (impresoras, discos) de las máquinas de la red.',
            'Se basa en sistemas abiertos: protocolos estándares que facilitan combinar equipos y software de distintos proveedores.',
            'Permite ejecutar procesos concurrentes sobre la misma computadora de la red.',
            'Suele ser escalable (sumar recursos), aunque depende de las posibilidades de la red que los conecta.',
            'Mayor tolerancia a fallos: si una computadora cae, la red sigue, aun con servicio un poco degradado.',
          ] },
          { type: 'callout', tone: 'criollo', text: 'Repartís la carga entre varias máquinas: si se cae una, el sistema sigue rengueando pero no se muere.' },
        ] },
        { id: '14', title: 'Sistemas embebidos', blocks: [
          { type: 'p', text: 'En los sistemas embebidos o empotrados, las funciones del software no suelen estar a la vista del usuario. Se diseñan para realizar una o pocas funciones, generalmente dentro de un sistema de tiempo real.' },
          { type: 'p', text: 'Sus componentes suelen estar incluidos en una placa base y pueden no verse como computadoras (ej.: el reloj de los taxis, el microondas). Generalmente se programan en lenguaje ensamblador sobre el microprocesador.' },
          { type: 'p', text: '<strong>Características:</strong>' },
          { type: 'ul', items: [
            'Suelen fabricarse en forma masiva para reducir el coste de producción.',
            'Emplean un procesador y una memoria relativamente pequeños.',
            'Un fallo en un elemento implica reparar o reemplazar la placa íntegramente.',
            'Por la reducción de costos, sus controladores pueden ser más lentos que los de las PCs.',
          ] },
          { type: 'callout', tone: 'criollo', text: 'Están metidos adentro de cualquier aparato y ni los ves; eso sí, si se rompe algo, va la placa entera al tacho.' },
        ] },
      ],
    },
    {
      ...
      sections: [
        {
          ...
          title: 'Reingeniería de software',
          blocks: [
            { type: 'p', text: 'Una vez desarrollado, un sistema inevitablemente sufre modificaciones para adaptarse a los cambios del entorno y seguir siendo útil para la organización. La evolución del software es relevante porque la operatoria suele depender de esos sistemas, por lo que la organización debe seguir invirtiendo para mantenerlos o evolucionarlos.' },
            { type: 'callout', tone: 'info', text: 'Problema: si el sistema es útil, se le pedirá adaptarse a un entorno cambiante, y esa adaptación hace que su estructura se vaya <strong>degradando en forma paulatina</strong>.' },
            { type: 'p', text: 'El <strong>mantenimiento</strong> es cambiar algo en el sistema después de entregarlo al cliente. Va desde corregir un error en una línea de código hasta corregir errores de diseño o incorporar nuevos requerimientos.' },
            { type: 'callout', tone: 'warning', text: 'Los costos de mantenimiento son altos: incorporar una funcionalidad con el sistema ya funcionando cuesta más que durante el desarrollo, y los cambios <strong>inevitablemente introducen defectos</strong>.' },
            { type: 'p', text: 'La <strong>reingeniería</strong> es el proceso para mejorar un software existente. Las sucesivas modificaciones hacen estragos en programas que originalmente podían estar pensados para optimizar recursos; la reingeniería mejora esa estructura y la comprensión del sistema.' },
            { type: 'callout', tone: 'info', text: 'Según Sommerville: «La reingeniería puede implicar redocumentar el sistema, organizar y reestructurarlo, traducirlo a un lenguaje más moderno, y modificar y actualizar la estructura y valores de los datos». Generalmente se hace <strong>sin cambiar su funcionalidad ni arquitectura</strong>.' },
            { type: 'p', text: 'Ventajas frente a desarrollar un sistema nuevo desde cero:' },
            { type: 'ul', items: [
              '<strong>Disminuir el riesgo</strong> de partir de cero, sobre todo en sistemas críticos de los que depende la operatoria de la empresa; un retraso en el sistema nuevo puede causar daños severos.',
              '<strong>Menor costo</strong>: aunque la reingeniería cuesta, siempre será menor que desarrollar un sistema completamente nuevo.',
            ] },
            { type: 'callout', tone: 'criollo', text: 'Mantener un sistema lo va rompiendo de a poco; reingeniería es arreglar lo que tenés sin tirar todo a la basura.' },
          ],
        },
        {
          id: '16',
          title: 'Métodos formales',
          blocks: [
            { type: 'callout', tone: 'info', text: '«Los métodos formales son técnicas con bases matemáticas para describir las propiedades del sistema. Proporcionan marcos dentro de los cuales se puede especificar, desarrollar y verificar los sistemas más que ad hoc». — <em>The Encyclopedia of Software Engineering</em>' },
            { type: 'p', text: 'En ingenierías como la electrónica o la civil se usan técnicas matemáticas de cajón, pero la ingeniería de software se resistió, pese a que desde los 80 varios autores lo marcaron como el único camino hacia la calidad. Razones por las que las especificaciones formales no se incorporaron a todos los desarrollos:' },
            { type: 'ul', items: [
              'Aparecieron otras herramientas y técnicas que mejoraron la calidad: nuevas metodologías, lenguajes orientados a objetos, administración de configuraciones, etc.',
              'No son aptas para dos aspectos críticos del mercado actual: la <strong>interfaz con el usuario</strong> y los <strong>desarrollos rápidos</strong>.',
              '<strong>No son escalables</strong>: son exitosas en aplicaciones críticas pequeñas, pero se descontrola su realización al aumentar el tamaño.',
            ] },
            { type: 'p', text: 'Hay dos aproximaciones para redactar especificaciones de sistemas industriales:' },
            { type: 'ul', items: [
              '<strong>Algebraica</strong>: describe el sistema empleando operaciones y sus relaciones.',
              '<strong>Basada en modelos</strong>: construye un modelo con construcciones matemáticas (conjuntos, sucesiones), y las operaciones se establecen indicando cómo modifican el estado del sistema.',
            ] },
            { type: 'p', text: 'Cada aproximación tiene lenguajes según el tipo de sistema (secuencial o concurrente):' },
            { type: 'table', headers: ['Aproximación', 'Sistema secuencial', 'Sistema concurrente'], rows: [
              ['Algebraica', 'Larch, OBJ', 'Lotos, Brinksma'],
              ['Basada en modelos', 'Z, VDM, B', 'CSP, redes de Petri'],
            ] },
            { type: 'p', text: 'Puntos clave de los métodos formales:' },
            { type: 'ul', items: [
              '<strong>Complementan</strong> las especificaciones informales por ser precisos y no ambiguos: eliminan dudas y evitan problemas de interpretación.',
              'Fuerzan un análisis de requerimientos en una etapa inicial, donde es <strong>menos costoso corregir un error</strong>.',
              'Son excelentes para sistemas críticos donde priman la <strong>seguridad y la confiabilidad</strong>.',
            ] },
            { type: 'p', text: '¿Qué técnica usar?' },
            { type: 'ul', items: [
              'Las técnicas <strong>algebraicas</strong> sirven para especificar interfaces (clases o tipos abstractos de datos): ocultan el estado del sistema y se basan en las relaciones entre las operaciones de la interfaz.',
              'Las basadas en <strong>modelos</strong> usan conjuntos y funciones, pueden mostrar el estado del sistema y simplifican la especificación del comportamiento mediante precondiciones y postcondiciones sobre el estado.',
            ] },
            { type: 'callout', tone: 'criollo', text: 'Lindos en teoría y geniales para sistemas críticos, pero no escalan ni sirven para UI ni desarrollos rápidos: por eso nunca pegaron.' },
          ],
        },
      ],
    },
    {
      unit: 'tp',
      sections: [
        { id: 'tp.1', title: 'Parte 1 — Determinación del modelo de ciclo de vida', blocks: [
          { type: 'p', text: 'El caso es el <strong>Sistema para librería de compra y reventa de artículos</strong>. El método: antes de elegir modelo, se extraen las características del proyecto del enunciado, separadas en <strong>organización</strong> y <strong>requerimientos</strong>, y con eso se justifica la elección.' },
          { type: 'p', text: 'Características clave del caso: maneja ventas <strong>minoristas y mayoristas</strong>; showroom en microcentro más depósito; trabaja con <strong>4 proveedores</strong> (pedidos los viernes); los <strong>pagos quedan fuera</strong> del sistema (los maneja Contable, lo que delimita el alcance); el <strong>hardware ya está comprado</strong> (restricción inamovible desde el día cero); requisitos definidos y dominio conocido, con posibles requisitos futuros (reportes).' },
          { type: 'p', text: 'Modelo elegido: <strong>incremental</strong>. La idea es construir el sistema en partes funcionales (incrementos) que ya entregan valor antes de completarlo.' },
          { type: 'ol', items: [
            'Requisitos conocidos pero divisibles en partes funcionales (stock, pedidos, ventas minoristas y mayoristas), cada una un incremento independiente.',
            'El cliente puede ver y usar avances rápido: módulos críticos operativos sin esperar el sistema completo.',
            'La restricción de hardware es conocida desde el inicio: se planifica dentro de ella sin revisar riesgos en cada ciclo.',
            'No hay alta incertidumbre en los requisitos: descarta prototipos y evolutivo.',
            'No es un proyecto de alto riesgo tecnológico: descarta espiral.',
          ] },
          { type: 'table', headers: ['Modelo', '¿Va? Por qué'], rows: [
            ['Incremental', 'SÍ. Requisitos conocidos pero divisibles, entrega de valor temprana, hardware fijo desde el inicio.'],
            ['Prototipos / Evolutivo', 'NO. Sirven con alta incertidumbre; acá los requisitos están definidos y el dominio es concreto.'],
            ['Espiral', 'NO. Para proyectos grandes con muchos riesgos; acá es empresa mediana con tecnología estándar.'],
          ] },
          { type: 'p', text: 'Conclusión: ciclo de vida <strong>incremental</strong> para dar valor desde las primeras etapas y minimizar el impacto en la operación diaria, facilitando agregar reportes a futuro sin tocar la base. <strong>Scrum</strong> acompaña bien con iteraciones cortas y revisiones periódicas con el cliente.' },
          { type: 'callout', tone: 'criollo', text: 'Para defender: incremental porque los requisitos están claros pero se parten en módulos que entregan valor rápido. Prototipos/evolutivo se caen (no hay incertidumbre), espiral se cae (no hay alto riesgo tecnológico).' },
        ] },
        { id: 'tp.2', title: 'Parte 2 — Organigrama y entrevistas', blocks: [
          { type: 'p', text: 'El método es el relevamiento: presentar el organigrama y sintetizar tres entrevistas (Ventas, Compras, Depósito) para detectar los problemas que justifican el sistema. El <strong>organigrama</strong> arranca en el Gerente General, del que dependen cuatro áreas: <strong>Comercial</strong>, <strong>Logística y depósito</strong>, <strong>Compras</strong> y <strong>Contable</strong>; Proveedores cuelga de Compras como vínculo externo (línea punteada). Ver organigrama en la sección completa.' },
          { type: 'p', text: '<strong>Entrevista Ventas:</strong> minorista es directo (showroom, consulta stock, cierra en el momento, ticket o factura); mayorista es por mail/WhatsApp, verifica stock, presupuesto con precio mayorista, factura más remito. El cobro lo maneja Contaduría aparte. Hoy las ventas se cargan a mano en una planilla de Excel compartida, que a veces queda desactualizada.' },
          { type: 'p', text: '<strong>Entrevista Compras:</strong> los pedidos a los 4 proveedores se arman los <strong>viernes</strong>, decidiendo por <strong>stock mínimo</strong> y <strong>rotación</strong>. Con eso se arma un <strong>informe de faltantes</strong> y la <strong>orden de compra</strong> que se envía por mail. No hay seguimiento formal del estado de la orden y la confirmación del proveedor es informal.' },
          { type: 'p', text: '<strong>Entrevista Depósito:</strong> control de stock con planillas y recuentos físicos. Al recibir mercadería controla el <strong>remito contra la orden de compra</strong> y luego hace <strong>control de calidad</strong>; si no coincide o viene con fallas, registra, notifica al proveedor y rechaza o acepta solo lo bueno. El stock se actualiza a mano, por eso queda desfasado.' },
          { type: 'ul', items: [
            '<strong>Información dispersa</strong>: venta en una planilla, stock en otra, pedidos en el mail.',
            '<strong>Carga manual</strong>: errores de tipeo y dependencia de quién toca las planillas.',
            '<strong>Stock desactualizado</strong>: no refleja la realidad, lleva a pedir de más/menos y a frenar ventas.',
          ] },
          { type: 'callout', tone: 'criollo', text: 'Las tres áreas terminan pidiendo lo mismo: un sistema único donde la venta descuente stock sola, el ingreso lo actualice y todos vean la misma info. Esa necesidad justifica todo el proyecto.' },
        ] },
        { id: 'tp.3', title: 'Parte 3 — Procesos de negocio (BPMN)', blocks: [
          { type: 'p', text: 'Se modelan los procesos con <strong>BPMN</strong>: un <strong>proceso general</strong> de alto nivel y <strong>tres subprocesos</strong> (ventas, gestión de pedidos a proveedor e ingreso de mercadería). Cada diagrama usa <em>pools</em> (participantes) y <em>carriles</em> (áreas internas). Lo defendible son los <strong>gateways</strong> (decisiones) y los caminos alternativos. Ver diagramas en la sección completa.' },
          { type: 'p', text: '<strong>Proceso general:</strong> cuatro pools (Cliente, Proceso General con carriles Comercial/Compras/Depósito, y Proveedor). Cada área tiene su propio disparador: Comercial arranca con el <strong>pedido del cliente</strong> (gateway mayorista/minorista que invoca el subproceso correspondiente), Compras con un <strong>evento temporal semanal</strong>, y Depósito con el <strong>ingreso de mercadería</strong>. El Proveedor recibe la orden y despacha.' },
          { type: 'p', text: '<strong>Subproceso de ventas:</strong> dos gateways. Uno separa minorista (showroom) de mayorista; el otro, <strong>¿hay stock suficiente?</strong>. Sin stock se informa la falta y el cliente recibe el rechazo (corta). Con stock: confirmar, registrar, preparar, enviar y recién entonces <strong>actualizar stock</strong>.' },
          { type: 'p', text: '<strong>Subproceso de gestión de pedidos a proveedor:</strong> disparador temporal y <strong>gateway paralelo</strong> que lanza en simultáneo dos consultas (más vendidos a Comercial, stock bajo mínimo a Depósito); al unirse (join) se revisan los informes y un gateway <strong>¿se aprueba la compra?</strong> decide: No corta; Sí registra en Excel, genera la orden y la envía a proveedores.' },
          { type: 'p', text: '<strong>Subproceso de ingreso de mercadería:</strong> dos gateways en cadena. Primero <strong>¿coincide la factura con la orden de compra?</strong> y luego <strong>¿buena calidad?</strong>. Cualquiera que falle registra error, notifica al proveedor y confluye en el rechazo. Solo pasando ambos se ingresa al stock y se almacena.' },
          { type: 'callout', tone: 'criollo', text: 'Lo fino para defender: el gateway de stock que parte la venta, el gateway paralelo de pedidos (las dos consultas van juntas) y los dos controles en cadena del ingreso, cada uno con su escape al rechazo.' },
        ] },
        { id: 'tp.4', title: 'Parte 4 — Especificación de requerimientos', blocks: [
          { type: 'p', text: 'La especificación se organiza en tres grupos con código de trazabilidad: <strong>funcionales</strong> (<code>RFx</code>, qué hace, agrupados por área), <strong>no funcionales</strong> (<code>RNFx</code>, cómo se comporta) y <strong>de negocio</strong> (<code>RNx</code>, los límites del alcance).' },
          { type: 'p', text: 'Los <strong>funcionales (RF1–RF23)</strong> van por área del negocio: <strong>Ventas</strong> (RF1–RF5: registrar venta minorista y pedido mayorista, verificar stock antes de confirmar mayorista, precios diferenciados, comprobantes); <strong>Stock</strong> (RF6–RF9: mantener y consultar stock en tiempo real, descontar al vender e incrementar al ingresar mercadería); <strong>Compras</strong> (RF10–RF15: registrar y generar pedidos periódicos, soporte a decisión por stock/ventas, órdenes de compra, envío y confirmación del proveedor); <strong>Ingreso de mercadería</strong> (RF16–RF18: registrar recepción, verificar contra el pedido, registrar inconsistencias); <strong>Información</strong> (RF19–RF21: centralizar planillas/correos, historial de ventas y compras); <strong>Usuarios</strong> (RF22–RF23: roles y acceso concurrente). Ver listado completo en la sección.' },
          { type: 'table', headers: ['Código', 'No funcional'], rows: [
            ['RNF1', 'Tiempos de respuesta adecuados en consulta de stock en tiempo real.'],
            ['RNF2', 'Control de acceso basado en roles de usuario.'],
            ['RNF3', 'Compatibilidad con el hardware existente.'],
            ['RNF4', 'Interfaz simple e intuitiva.'],
            ['RNF5', 'Consistencia de la información, evitando discrepancias en el stock.'],
          ] },
          { type: 'ul', items: [
            '<strong>RN1</strong>: el sistema debe soportar ventas minoristas y mayoristas.',
            '<strong>RN2</strong>: el sistema <strong>no</strong> debe incluir la gestión de pagos.',
            '<strong>RN3</strong>: el sistema debe contemplar un conjunto reducido de proveedores.',
          ] },
          { type: 'callout', tone: 'criollo', text: 'Los recortes de alcance son lo más apretable: por RN2 no hay pagos y por RN3 solo proveedores reducidos. Y los funcionales se reconstruyen acordándote de las áreas: Ventas, Stock, Compras, Ingreso, Información y Usuarios.' },
        ] },
        { id: 'tp.5', title: 'Parte 5 — Diagrama de casos de uso', blocks: [
          { type: 'p', text: 'A partir de los requerimientos (Parte 4) y el organigrama (Parte 2) se modela el <strong>diagrama de casos de uso</strong>. Son <strong>seis actores</strong>: Vendedor, Jefe de depósito, Gerente de Compras, Gerente General, Proveedor y Administrador. Cinco mapean a cargos del organigrama; el <strong>Administrador</strong> es rol puramente del sistema (no figura en el organigrama). Ver diagrama en la sección completa.' },
          { type: 'p', text: 'Relaciones del diagrama: <strong>«include»</strong> = el caso siempre ejecuta a otro (CU1 y CU2 incluyen Verificar disponibilidad de stock y Generar comprobante de venta); <strong>«extend»</strong> = se ejecuta solo bajo condición (CU4 extiende a Registrar inconsistencias si las cantidades no coinciden; CU5 extiende a Generar pedido periódico si se elige esa opción).' },
          { type: 'table', headers: ['CU', 'Caso de uso', 'Actor'], rows: [
            ['CU1', 'Registrar venta minorista (precio minorista, valida stock, descuenta, comprobante)', 'Vendedor'],
            ['CU2', 'Registrar pedido mayorista (cliente registrado, validación estricta de stock, precio mayorista)', 'Vendedor'],
            ['CU3', 'Consultar stock en tiempo real (solo lectura)', 'Jefe de depósito'],
            ['CU4', 'Registrar ingreso de mercadería (contrasta contra la OC, suma al stock)', 'Jefe de depósito'],
            ['CU5', 'Generar orden de compra (con sugerencias de reposición)', 'Gerente de Compras'],
            ['CU6', 'Gestionar usuarios y roles (altas/bajas/modif., acceso por rol)', 'Administrador'],
            ['CU7', 'Consultar historial de ventas y compras (reportes con filtros)', 'Gerente General'],
            ['CU8', 'Confirmar orden de compra (confirma/rechaza/acepta parcial en portal externo)', 'Proveedor'],
          ] },
          { type: 'p', text: 'Cada CU lleva su identificador de RFs que cubre, descripción, precondición, flujo y flujos alternativos. Además se redactan <strong>8 historias de usuario</strong> (formato «Como… / Quiero… / Para…»), una por cada caso de uso con el mismo actor. CU8 es el único disparado por un actor externo (Proveedor) y notifica a Compras.' },
          { type: 'callout', tone: 'criollo', text: 'Clavá el mapeo actor→CU y las relaciones: «include» son obligatorias (verificar stock + comprobante en CU1/CU2), «extend» son condicionales (inconsistencias en CU4, pedido periódico en CU5).' },
        ] },
        { id: 'tp.6', title: 'Parte 6 — Diagramas de secuencia y modelo de datos', blocks: [
          { type: 'p', text: 'La Parte 6 continúa la 5 y hace tres cosas: (a) describir las <strong>cuatro subfunciones</strong> que faltaban, (b) mostrar cada CU por dentro con un <strong>diagrama de secuencia</strong>, y (c) armar el <strong>modelo de datos preliminar</strong>. Ver diagramas en la sección completa.' },
          { type: 'p', text: 'Las cuatro subfunciones no las inicia un actor: se ejecutan dentro de su CU principal. <strong>S1 — Verificar disponibilidad de stock</strong> (<code>RF3, RF6, RF9</code>, «incluye» en CU1/CU2, solo consulta, no cambia datos); <strong>S2 — Generar comprobante de venta</strong> (<code>RF5</code>, «incluye» en CU1/CU2, el sistema no cobra); <strong>S3 — Registrar inconsistencias</strong> (<code>RF18</code>, «extiende» CU4, solo si hay diferencias); <strong>S4 — Generar pedido periódico</strong> (<code>RF11, RF12</code>, «extiende» CU5, arma solo un borrador).' },
          { type: 'p', text: 'Los <strong>diagramas de secuencia</strong> muestran, por cada CU, qué objetos participan (actor, pantalla, gestor de control y entidades) y el orden de mensajes. Ejemplos: CU1/CU2 verifican stock («incluye» S1), agregan al detalle, descuentan stock y generan comprobante («incluye» S2); CU4 compara cantidades contra la OC y, si difieren, «extiende» S3 dejando la orden parcial; CU5 puede «extender» S4 con un borrador automático; CU8 marca la orden confirmada/rechazada/parcial y avisa al Gerente de Compras.' },
          { type: 'p', text: 'El <strong>modelo de datos preliminar</strong> sale de las entidades de los diagramas de secuencia: Usuario, Rol, Producto, Cliente, Venta, Detalle de Venta, Proveedor, Orden de Compra, Detalle de Orden de Compra, Ingreso de Mercadería e Inconsistencia. Relaciones clave: una Venta tiene varios Detalles y cada Detalle es un Producto; una Orden de Compra tiene varios Detalles y pertenece a un Proveedor; el comprobante se guarda dentro de la Venta y el stock como dato del Producto. Ver tabla de datos completa en la sección.' },
          { type: 'p', text: 'Cierra con una <strong>tabla de trazabilidad</strong> CU → requerimientos → entidades, que demuestra que cada RF tiene su caso de uso y sus datos (RF19 y RF23, más los no funcionales, son generales y no caen en un solo CU). Ver tabla completa en la sección.' },
          { type: 'callout', tone: 'criollo', text: 'Regla de oro: «incluye» siempre pasa (S1 y S2 en cada venta), «extiende» pasa a veces (S3 si hay diferencias, S4 si el Gerente elige el pedido periódico). Y la trazabilidad es el as bajo la manga: nada quedó colgado.' },
        ] },
      ],
    },
    ],
